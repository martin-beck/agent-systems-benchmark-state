...
| #91 | `feature/tui-multi-agent-provider-selection@679244e3af61` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED: | feat(tui): add multi-agent provider selection |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34292301985 | `679244e3af61` | pull_request | Huawei MIT source headers | queued:- |
| 34292301938 | `679244e3af61` | pull_request | Formal assurance | queued:- |
...
| 34292301877 | `679244e3af61` | pull_request | Agent Workflow Quality shadow | queued:- |
| 34292301862 | `679244e3af61` | pull_request | Fault assurance | queued:- |
| 34292301855 | `679244e3af61` | pull_request | Rust verification | queued:- |
