...
| --- | --- | --- | --- | --- | --- |
| #337 | `release/ar-1462-pinned-release-toolchain-bundle-workflow@52c5108a17fc` | `main` | UNSTABLE | COMPLETED:FAILURE, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | AR-1462: pinned offline release tooling and bundle workflow |
...
| 36266426510 | `52c5108a17fc` | pull_request | Fault assurance | completed:success |
| 36266426497 | `52c5108a17fc` | pull_request | Hosted portability and native qualification | completed:success |
