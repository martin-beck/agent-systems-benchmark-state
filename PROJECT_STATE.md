...
| #328 | `feature/ar-1450-runtime-owned-local-replay-acquisition@185062d73458` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(runtime): add local replay provisioning boundary |
...
| --- | --- | --- | --- | --- |
| 36183507212 | `185062d73458` | pull_request | Huawei MIT source headers | completed:success |
| 36183507165 | `185062d73458` | pull_request | Agent Workflow Quality shadow | completed:success |
| 36183507162 | `185062d73458` | pull_request | Repository quality | in_progress:- |
| 36183507159 | `185062d73458` | pull_request | Rust verification | in_progress:- |
| 36183507156 | `185062d73458` | pull_request | Fault assurance | completed:success |
| 36183507150 | `185062d73458` | pull_request | Formal assurance | completed:success |
