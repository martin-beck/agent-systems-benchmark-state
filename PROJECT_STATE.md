...
| #177 | `feature/ar-1228-auth-backends-probes@16375248089f` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS | feat(auth): bind concrete credential resolvers |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35021111333 | `16375248089f` | pull_request | Fault assurance | in_progress:- |
| 35021111226 | `16375248089f` | pull_request | Huawei MIT source headers | completed:success |
| 35021111214 | `16375248089f` | pull_request | Formal assurance | in_progress:- |
