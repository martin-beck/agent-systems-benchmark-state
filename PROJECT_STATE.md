...
| #255 | `feature/ar-1334-openrouter-conformance-qualification@979dfe692369` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | test: qualify OpenRouter free model hostile conformance |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35840794712 | `979dfe692369` | pull_request | Huawei MIT source headers | in_progress:- |
| 35840794631 | `979dfe692369` | pull_request | Hosted portability and native qualification | in_progress:- |
| 35840794618 | `979dfe692369` | pull_request | Formal assurance | in_progress:- |
| 35840794590 | `979dfe692369` | pull_request | Agent Workflow Quality shadow | in_progress:- |
| 35840794523 | `979dfe692369` | pull_request | Rust verification | in_progress:- |
| 35840794520 | `979dfe692369` | pull_request | Fault assurance | in_progress:- |
