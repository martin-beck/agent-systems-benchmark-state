...
| #179 | `feature/ar-1229-auth-application-integration@c705dfe9a513` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, QUEUED:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat: integrate provider authentication application surfaces |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35029861586 | `c705dfe9a513` | pull_request | Hosted portability and native qualification | in_progress:- |
| 35029861542 | `c705dfe9a513` | pull_request | Huawei MIT source headers | in_progress:- |
| 35029861526 | `c705dfe9a513` | pull_request | Repository quality | in_progress:- |
| 35029861454 | `c705dfe9a513` | pull_request | Rust verification | in_progress:- |
| 35029861452 | `c705dfe9a513` | pull_request | Fault assurance | in_progress:- |
| 35029861433 | `c705dfe9a513` | pull_request | Agent Workflow Quality shadow | in_progress:- |
| 35029861422 | `c705dfe9a513` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35029861417 | `c705dfe9a513` | pull_request | Formal assurance | queued:- |
