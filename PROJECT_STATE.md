...
| #177 | `feature/ar-1228-auth-backends-probes@2d716c8cac94` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS | feat(auth): bind concrete credential resolvers |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35025970637 | `2d716c8cac94` | pull_request | Repository quality | in_progress:- |
| 35025970625 | `2d716c8cac94` | pull_request | Hosted portability and native qualification | completed:success |
| 35025970594 | `2d716c8cac94` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35025970584 | `2d716c8cac94` | pull_request | Fault assurance | in_progress:- |
| 35025970579 | `2d716c8cac94` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35025970549 | `2d716c8cac94` | pull_request | Rust verification | in_progress:- |
| 35025970543 | `2d716c8cac94` | pull_request | Formal assurance | in_progress:- |
| 35025970538 | `2d716c8cac94` | pull_request | Huawei MIT source headers | completed:success |
| 35025315168 | `0a5927c6219e` | pull_request | Emulated aarch64 portability | completed:failure |
| 35025315147 | `0a5927c6219e` | pull_request | Repository quality | completed:success |
| 35025315146 | `0a5927c6219e` | pull_request | Fault assurance | completed:success |
| 35025315142 | `0a5927c6219e` | pull_request | Huawei MIT source headers | completed:success |
