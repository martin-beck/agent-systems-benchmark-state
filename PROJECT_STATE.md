...
| #197 | `feature/ar-1248-strict-replay-cli-contract@cebe8efc19a1` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS | feat(cli): define strict offline replay consumer contract |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35089836815 | `cebe8efc19a1` | pull_request | Fault assurance | in_progress:- |
| 35089836807 | `cebe8efc19a1` | pull_request | Formal assurance | in_progress:- |
| 35089836795 | `cebe8efc19a1` | pull_request | Hosted portability and native qualification | completed:success |
| 35089836751 | `cebe8efc19a1` | pull_request | Rust verification | in_progress:- |
...
| 35089836714 | `cebe8efc19a1` | pull_request | Repository quality | in_progress:- |
