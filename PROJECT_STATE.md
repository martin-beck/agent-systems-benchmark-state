...
| #124 | `feature/openjiuwen-live@fb6a57217033` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED: | test(agents): qualify pinned OpenJiuwen live execution |
...
| --- | --- | --- | --- | --- |
| 35068170238 | `fb6a57217033` | pull_request | Agent Workflow Quality shadow | queued:- |
| 35068170184 | `fb6a57217033` | pull_request | Huawei MIT source headers | queued:- |
| 35068170108 | `fb6a57217033` | pull_request | Formal assurance | queued:- |
| 35068169984 | `fb6a57217033` | pull_request | Rust verification | queued:- |
| 35068169929 | `fb6a57217033` | pull_request | Fault assurance | queued:- |
| 35068169917 | `fb6a57217033` | pull_request | Hosted portability and native qualification | queued:- |
| 35068169830 | `fb6a57217033` | pull_request | Repository quality | queued:- |
| 35068169793 | `fb6a57217033` | pull_request | Emulated aarch64 portability | queued:- |
