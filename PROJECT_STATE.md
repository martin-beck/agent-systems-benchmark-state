...
| #233 | `repair/ar-1312-post-merge-coverage-floor@6958f08e1f6e` | `main` | CLEAN | COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | test: isolate instrumented child profiles |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35432483773 | `6958f08e1f6e` | pull_request | Rust verification | completed:success |
| 35432483762 | `6958f08e1f6e` | pull_request | Emulated aarch64 portability | completed:success |
| 35432483750 | `6958f08e1f6e` | pull_request | Fault assurance | completed:success |
| 35432483746 | `6958f08e1f6e` | pull_request | Formal assurance | completed:success |
| 35432483741 | `6958f08e1f6e` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35432483740 | `6958f08e1f6e` | pull_request | Repository quality | completed:success |
| 35432483730 | `6958f08e1f6e` | pull_request | Huawei MIT source headers | completed:success |
| 35432483728 | `6958f08e1f6e` | pull_request | Hosted portability and native qualification | completed:success |
