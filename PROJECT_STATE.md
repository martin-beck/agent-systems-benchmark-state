...
| #288 | `codex/ar-1396-literature-selection@58bc56f0b793` | `main` | UNSTABLE | QUEUED:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat(workloads): expose literature selection catalog |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35988348692 | `58bc56f0b793` | pull_request | Fault assurance | in_progress:- |
| 35988348610 | `58bc56f0b793` | pull_request | Formal assurance | queued:- |
| 35988348589 | `58bc56f0b793` | pull_request | Rust verification | in_progress:- |
| 35988348581 | `58bc56f0b793` | pull_request | Huawei MIT source headers | in_progress:- |
| 35988348579 | `58bc56f0b793` | pull_request | Hosted portability and native qualification | in_progress:- |
| 35988348576 | `58bc56f0b793` | pull_request | Emulated aarch64 portability | pending:- |
| 35988348569 | `58bc56f0b793` | pull_request | Agent Workflow Quality shadow | in_progress:- |
| 35988348568 | `58bc56f0b793` | pull_request | Repository quality | in_progress:- |
| 35987586186 | `e1e532ea1d4e` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35987586000 | `e1e532ea1d4e` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35987585987 | `e1e532ea1d4e` | pull_request | Formal assurance | completed:success |
| 35987585975 | `e1e532ea1d4e` | pull_request | Repository quality | completed:cancelled |
