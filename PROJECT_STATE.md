...
| #264 | `feature/ar-1356-control-runtime-attestation-primitive@ce7401a2c6e7` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, QUEUED:, IN_PROGRESS:, QUEUED:, IN_PROGRESS: | feat(runtime): bind live enrollment to control attestation |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35921962247 | `ce7401a2c6e7` | pull_request | Rust verification | pending:- |
| 35921962228 | `ce7401a2c6e7` | pull_request | Fault assurance | queued:- |
...
| 35921962161 | `ce7401a2c6e7` | pull_request | Agent Workflow Quality shadow | in_progress:- |
| 35921962075 | `ce7401a2c6e7` | pull_request | Huawei MIT source headers | in_progress:- |
| 35921962053 | `ce7401a2c6e7` | pull_request | Formal assurance | queued:- |
| 35921962011 | `ce7401a2c6e7` | pull_request | Hosted portability and native qualification | in_progress:- |
| 35921309050 | `70f8a3980cb0` | pull_request | Rust verification | in_progress:- |
