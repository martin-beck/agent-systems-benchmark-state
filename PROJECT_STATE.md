...
| #126 | `fix/main-merge-integrity@aceb1910b920` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | tools: harden signed merge publication |
...
| --- | --- | --- | --- | --- |
| 35057669149 | `aceb1910b920` | pull_request | Repository quality | in_progress:- |
| 35057669146 | `aceb1910b920` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35057669117 | `aceb1910b920` | pull_request | Rust verification | in_progress:- |
| 35057669116 | `aceb1910b920` | pull_request | Huawei MIT source headers | completed:success |
| 35057669115 | `aceb1910b920` | pull_request | Fault assurance | completed:success |
| 35057669102 | `aceb1910b920` | pull_request | Hosted portability and native qualification | completed:success |
| 35057669083 | `aceb1910b920` | pull_request | Formal assurance | in_progress:- |
| 35057669012 | `aceb1910b920` | pull_request | Agent Workflow Quality shadow | completed:success |
