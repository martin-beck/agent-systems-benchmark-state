...
| #229 | `feature/ar-1310-provider-capture-campaign@a6a3e43cce68` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat: qualify runtime provider capture campaigns |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35390406888 | `a6a3e43cce68` | pull_request | Huawei MIT source headers | completed:success |
| 35390406870 | `a6a3e43cce68` | pull_request | Fault assurance | completed:success |
| 35390406740 | `a6a3e43cce68` | pull_request | Formal assurance | completed:success |
| 35390406607 | `a6a3e43cce68` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35390406567 | `a6a3e43cce68` | pull_request | Emulated aarch64 portability | completed:success |
| 35390406546 | `a6a3e43cce68` | pull_request | Rust verification | completed:success |
| 35390406545 | `a6a3e43cce68` | pull_request | Hosted portability and native qualification | completed:success |
| 35390406423 | `a6a3e43cce68` | pull_request | Repository quality | completed:failure |
| 35389941221 | `75fe4b803d73` | pull_request | Rust verification | completed:failure |
| 35389941210 | `75fe4b803d73` | pull_request | Repository quality | completed:failure |
| 35389941203 | `75fe4b803d73` | pull_request | Fault assurance | completed:failure |
| 35389941198 | `75fe4b803d73` | pull_request | Agent Workflow Quality shadow | completed:success |
