...
| #176 | `feature/ar-1120@8641bff13f61` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(auth): add credential enrollment lifecycle |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35002176342 | `8641bff13f61` | pull_request | Huawei MIT source headers | completed:success |
| 35002175952 | `8641bff13f61` | pull_request | Repository quality | completed:success |
| 35002175951 | `8641bff13f61` | pull_request | Hosted portability and native qualification | completed:success |
| 35002175869 | `8641bff13f61` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35002175848 | `8641bff13f61` | pull_request | Rust verification | completed:failure |
| 35002175838 | `8641bff13f61` | pull_request | Fault assurance | completed:success |
| 35002175822 | `8641bff13f61` | pull_request | Emulated aarch64 portability | completed:success |
| 35002175806 | `8641bff13f61` | pull_request | Formal assurance | completed:success |
| 35001205330 | `032f620b52ea` | pull_request | Formal assurance | completed:success |
| 35001205319 | `032f620b52ea` | pull_request | Emulated aarch64 portability | completed:success |
| 35001205298 | `032f620b52ea` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35001205238 | `032f620b52ea` | pull_request | Hosted portability and native qualification | completed:success |
