...
| #177 | `feature/ar-1228-auth-backends-probes@ca5ba5ac6668` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED: | feat(auth): bind concrete credential resolvers |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35024556798 | `ca5ba5ac6668` | pull_request | Rust verification | queued:- |
| 35024556776 | `ca5ba5ac6668` | pull_request | Huawei MIT source headers | queued:- |
| 35024556757 | `ca5ba5ac6668` | pull_request | Fault assurance | queued:- |
| 35024556735 | `ca5ba5ac6668` | pull_request | Emulated aarch64 portability | queued:- |
| 35024556729 | `ca5ba5ac6668` | pull_request | Hosted portability and native qualification | queued:- |
| 35024556726 | `ca5ba5ac6668` | pull_request | Repository quality | queued:- |
| 35024556725 | `ca5ba5ac6668` | pull_request | Agent Workflow Quality shadow | queued:- |
| 35024556717 | `ca5ba5ac6668` | pull_request | Formal assurance | queued:- |
