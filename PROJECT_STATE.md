...
| #197 | `feature/ar-1248-strict-replay-cli-contract@7a0a7cc5c14d` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED: | feat(cli): define strict offline replay consumer contract |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35088397746 | `7a0a7cc5c14d` | pull_request | Formal assurance | queued:- |
| 35088397706 | `7a0a7cc5c14d` | pull_request | Hosted portability and native qualification | queued:- |
| 35088397685 | `7a0a7cc5c14d` | pull_request | Fault assurance | queued:- |
| 35088397678 | `7a0a7cc5c14d` | pull_request | Huawei MIT source headers | queued:- |
| 35088397659 | `7a0a7cc5c14d` | pull_request | Repository quality | pending:- |
| 35088397657 | `7a0a7cc5c14d` | pull_request | Agent Workflow Quality shadow | queued:- |
| 35088397643 | `7a0a7cc5c14d` | pull_request | Emulated aarch64 portability | queued:- |
| 35088397632 | `7a0a7cc5c14d` | pull_request | Rust verification | queued:- |
