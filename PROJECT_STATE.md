...
| #264 | `feature/ar-1356-control-runtime-attestation-primitive@9e587593c2fd` | `main` | UNSTABLE | QUEUED:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat(runtime): bind live enrollment to control attestation |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35922366273 | `9e587593c2fd` | pull_request | Agent Workflow Quality shadow | in_progress:- |
| 35922366266 | `9e587593c2fd` | pull_request | Hosted portability and native qualification | in_progress:- |
| 35922366265 | `9e587593c2fd` | pull_request | Repository quality | pending:- |
| 35922366246 | `9e587593c2fd` | pull_request | Fault assurance | in_progress:- |
| 35922366231 | `9e587593c2fd` | pull_request | Rust verification | pending:- |
| 35922366224 | `9e587593c2fd` | pull_request | Huawei MIT source headers | in_progress:- |
| 35922366213 | `9e587593c2fd` | pull_request | Emulated aarch64 portability | pending:- |
| 35922366184 | `9e587593c2fd` | pull_request | Formal assurance | pending:- |
