...
| #229 | `feature/ar-1310-provider-capture-campaign@1625655a0a95` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, IN_PROGRESS:, IN_PROGRESS:, QUEUED:, IN_PROGRESS:, QUEUED:, QUEUED: | feat: qualify runtime provider capture campaigns |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35391247400 | `1625655a0a95` | pull_request | Agent Workflow Quality shadow | in_progress:- |
| 35391247332 | `1625655a0a95` | pull_request | Formal assurance | queued:- |
| 35391247312 | `1625655a0a95` | pull_request | Huawei MIT source headers | queued:- |
| 35391247288 | `1625655a0a95` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35391247255 | `1625655a0a95` | pull_request | Rust verification | queued:- |
| 35391247253 | `1625655a0a95` | pull_request | Fault assurance | in_progress:- |
| 35391247234 | `1625655a0a95` | pull_request | Repository quality | in_progress:- |
| 35391247203 | `1625655a0a95` | pull_request | Hosted portability and native qualification | in_progress:- |
