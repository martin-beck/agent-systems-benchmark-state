...
| #147 | `dependabot/cargo/sha2-0.11.0@9adca6072c3b` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:FAILURE, COMPLETED:FAILURE, COMPLETED:FAILURE, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:FAILURE, COMPLETED:FAILURE, COMPLETED:FAILURE, IN_PROGRESS: | build(deps): Bump sha2 from 0.10.9 to 0.11.0 |
...
| #151 | `dependabot/cargo/serde-1.0.229@07d4b62ad5c1` | `main` | UNSTABLE | COMPLETED:FAILURE, QUEUED:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:FAILURE, IN_PROGRESS: | build(deps): Bump serde from 1.0.220 to 1.0.229 |
...
| 35178551438 | `07d4b62ad5c1` | pull_request | Hosted portability and native qualification | in_progress:- |
