...
| #64 | `feature/executable-guides@5b62f9e7ef9d` | `main` | CLEAN | - | docs: add executable offline guides |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34195375125 | `5b62f9e7ef9d` | pull_request | Fault assurance | queued:- |
| 34195375104 | `5b62f9e7ef9d` | pull_request | Emulated aarch64 portability | queued:- |
| 34195375069 | `5b62f9e7ef9d` | pull_request | Rust verification | queued:- |
| 34195375063 | `5b62f9e7ef9d` | pull_request | Repository quality | queued:- |
| 34195375061 | `5b62f9e7ef9d` | pull_request | Formal assurance | queued:- |
