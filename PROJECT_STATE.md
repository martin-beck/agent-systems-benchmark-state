...
- Product remote main: `3406faae58f0e762f70a856f6b9c6c545fcc9a37`
- Local origin/main: `3406faae58f0e762f70a856f6b9c6c545fcc9a37`
...
| #258 | `feature/ar-1341-runtime-observed-namespace-repair@228bcc33957d` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | fix(runtime): attest live capability at child namespace boundary |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35852497167 | `228bcc33957d` | pull_request | Hosted portability and native qualification | in_progress:- |
| 35852497125 | `228bcc33957d` | pull_request | Fault assurance | in_progress:- |
| 35852497106 | `228bcc33957d` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35852497102 | `228bcc33957d` | pull_request | Huawei MIT source headers | completed:success |
| 35852497085 | `228bcc33957d` | pull_request | Formal assurance | in_progress:- |
| 35852497083 | `228bcc33957d` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35852497077 | `228bcc33957d` | pull_request | Rust verification | in_progress:- |
| 35852497066 | `228bcc33957d` | pull_request | Repository quality | in_progress:- |
| 35849949352 | `3406faae58f0` | push | Emulated aarch64 portability | completed:success |
| 35849949311 | `3406faae58f0` | push | Repository quality | completed:success |
| 35849949302 | `3406faae58f0` | push | Huawei MIT source headers | completed:success |
| 35849949296 | `3406faae58f0` | push | Formal assurance | completed:success |
