...
| #280 | `feature/ar-1385-runtime-live-dispatch-source@fd9517edb811` | `main` | UNSTABLE | COMPLETED:FAILURE, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(runtime): expose authenticated live dispatch source |
...
| 35962289854 | `fd9517edb811` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35962289851 | `fd9517edb811` | pull_request | Hosted portability and native qualification | completed:success |
| 35962289850 | `fd9517edb811` | pull_request | Repository quality | completed:failure |
