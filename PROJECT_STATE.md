...
| #298 | `codex/ar-1412-code-generation-controls@d7d035a6c09d` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(workloads): preserve code-generation control metrics |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 36014722850 | `d7d035a6c09d` | pull_request | Emulated aarch64 portability | in_progress:- |
...
| 36014722476 | `d7d035a6c09d` | pull_request | Repository quality | in_progress:- |
