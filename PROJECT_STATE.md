...
| #227 | `feature/ar-1160-control-lifecycle@3db1f4ccc86e` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, QUEUED:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat(control): add recording campaign lifecycle operations |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35370825762 | `3db1f4ccc86e` | pull_request | Agent Workflow Quality shadow | in_progress:- |
...
| 35370825682 | `3db1f4ccc86e` | pull_request | Huawei MIT source headers | in_progress:- |
| 35370825679 | `3db1f4ccc86e` | pull_request | Hosted portability and native qualification | in_progress:- |
| 35370825677 | `3db1f4ccc86e` | pull_request | Fault assurance | queued:- |
