...
| #179 | `feature/ar-1229-auth-application-integration@9c4741f934b3` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED: | feat: integrate provider authentication application surfaces |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35031299520 | `9c4741f934b3` | pull_request | Hosted portability and native qualification | queued:- |
| 35031299370 | `9c4741f934b3` | pull_request | Huawei MIT source headers | queued:- |
| 35031299348 | `9c4741f934b3` | pull_request | Formal assurance | queued:- |
| 35031299291 | `9c4741f934b3` | pull_request | Emulated aarch64 portability | queued:- |
| 35031299286 | `9c4741f934b3` | pull_request | Repository quality | queued:- |
| 35031299256 | `9c4741f934b3` | pull_request | Agent Workflow Quality shadow | queued:- |
| 35031299200 | `9c4741f934b3` | pull_request | Fault assurance | queued:- |
| 35031299157 | `9c4741f934b3` | pull_request | Rust verification | queued:- |
