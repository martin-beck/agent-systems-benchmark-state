...
| #179 | `feature/ar-1229-auth-application-integration@84d008cbc91d` | `main` | UNSTABLE | QUEUED:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat: integrate provider authentication application surfaces |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35030315939 | `84d008cbc91d` | pull_request | Hosted portability and native qualification | in_progress:- |
| 35030315884 | `84d008cbc91d` | pull_request | Repository quality | in_progress:- |
| 35030315838 | `84d008cbc91d` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35030315826 | `84d008cbc91d` | pull_request | Fault assurance | in_progress:- |
| 35030315811 | `84d008cbc91d` | pull_request | Formal assurance | in_progress:- |
| 35030315810 | `84d008cbc91d` | pull_request | Rust verification | in_progress:- |
| 35030315807 | `84d008cbc91d` | pull_request | Emulated aarch64 portability | pending:- |
| 35030315788 | `84d008cbc91d` | pull_request | Huawei MIT source headers | queued:- |
