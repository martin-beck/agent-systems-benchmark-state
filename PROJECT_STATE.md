...
| #177 | `feature/ar-1228-auth-backends-probes@727c11b3c4bd` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(auth): bind concrete credential resolvers |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35021476245 | `727c11b3c4bd` | pull_request | Huawei MIT source headers | completed:success |
| 35021476225 | `727c11b3c4bd` | pull_request | Rust verification | completed:success |
| 35021476186 | `727c11b3c4bd` | pull_request | Formal assurance | completed:success |
| 35021476162 | `727c11b3c4bd` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35021476159 | `727c11b3c4bd` | pull_request | Emulated aarch64 portability | completed:failure |
| 35021476145 | `727c11b3c4bd` | pull_request | Fault assurance | completed:success |
| 35021476117 | `727c11b3c4bd` | pull_request | Repository quality | completed:failure |
| 35021476105 | `727c11b3c4bd` | pull_request | Hosted portability and native qualification | completed:success |
| 35021111333 | `16375248089f` | pull_request | Fault assurance | completed:success |
| 35021111226 | `16375248089f` | pull_request | Huawei MIT source headers | completed:success |
| 35021111214 | `16375248089f` | pull_request | Formal assurance | completed:success |
| 35021111189 | `16375248089f` | pull_request | Rust verification | completed:cancelled |
