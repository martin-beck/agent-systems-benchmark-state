...
| #260 | `feature/ar-1344-runtime-cli-acquisition-contract@7b8d2966b8f4` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | Runtime-owned CLI live acquisition factory |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35870232677 | `7b8d2966b8f4` | pull_request | Formal assurance | in_progress:- |
| 35870232665 | `7b8d2966b8f4` | pull_request | Fault assurance | in_progress:- |
| 35870232656 | `7b8d2966b8f4` | pull_request | Huawei MIT source headers | in_progress:- |
| 35870232652 | `7b8d2966b8f4` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35870232626 | `7b8d2966b8f4` | pull_request | Agent Workflow Quality shadow | in_progress:- |
| 35870232605 | `7b8d2966b8f4` | pull_request | Repository quality | in_progress:- |
| 35870232580 | `7b8d2966b8f4` | pull_request | Hosted portability and native qualification | in_progress:- |
| 35870232564 | `7b8d2966b8f4` | pull_request | Rust verification | in_progress:- |
| 35858879195 | `d24221731891` | push | Rust verification | completed:success |
| 35858879191 | `d24221731891` | push | Fault assurance | completed:success |
| 35858879180 | `d24221731891` | push | Repository quality | completed:success |
