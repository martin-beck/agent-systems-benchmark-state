...
| #178 | `feature/ar-1230-authenticated-provider-request-seam@474e5461a61c` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(auth): add authenticated provider request seam |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35013970611 | `474e5461a61c` | pull_request | Formal assurance | in_progress:- |
...
| 35013970345 | `474e5461a61c` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35013970334 | `474e5461a61c` | pull_request | Rust verification | in_progress:- |
| 35013970321 | `474e5461a61c` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35013970291 | `474e5461a61c` | pull_request | Repository quality | in_progress:- |
| 35013766619 | `77464e034838` | pull_request | Huawei MIT source headers | completed:success |
| 35013766594 | `77464e034838` | pull_request | Rust verification | completed:cancelled |
| 35013766590 | `77464e034838` | pull_request | Formal assurance | completed:cancelled |
