...
| #128 | `feature/asb-tui-capabilities-command@d60d23510044` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | cli: expose frontend capabilities contract |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34522993395 | `d60d23510044` | pull_request | Rust verification | queued:- |
| 34522993351 | `d60d23510044` | pull_request | Agent Workflow Quality shadow | in_progress:- |
| 34522993329 | `d60d23510044` | pull_request | Formal assurance | in_progress:- |
| 34522993326 | `d60d23510044` | pull_request | Hosted portability and native qualification | queued:- |
...
| 34522993258 | `d60d23510044` | pull_request | Huawei MIT source headers | in_progress:- |
