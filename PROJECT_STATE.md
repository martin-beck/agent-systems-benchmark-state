...
| #294 | `codex/ar-1402-literature-cli@022561d8377a` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat(cli): dispatch literature workloads through catalog |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 36003236976 | `022561d8377a` | pull_request | Fault assurance | in_progress:- |
| 36003236966 | `022561d8377a` | pull_request | Formal assurance | in_progress:- |
| 36003236959 | `022561d8377a` | pull_request | Huawei MIT source headers | completed:success |
| 36003236942 | `022561d8377a` | pull_request | Hosted portability and native qualification | in_progress:- |
| 36003236940 | `022561d8377a` | pull_request | Rust verification | in_progress:- |
| 36003236933 | `022561d8377a` | pull_request | Agent Workflow Quality shadow | completed:success |
| 36003236895 | `022561d8377a` | pull_request | Repository quality | in_progress:- |
| 36003236879 | `022561d8377a` | pull_request | Emulated aarch64 portability | in_progress:- |
