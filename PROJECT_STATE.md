...
| #177 | `feature/ar-1228-auth-backends-probes@ad570f37a1f3` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(auth): bind concrete credential resolvers |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35007781359 | `ad570f37a1f3` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35007781138 | `ad570f37a1f3` | pull_request | Rust verification | in_progress:- |
| 35007781080 | `ad570f37a1f3` | pull_request | Repository quality | in_progress:- |
| 35007781067 | `ad570f37a1f3` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35007781061 | `ad570f37a1f3` | pull_request | Fault assurance | completed:success |
| 35007781044 | `ad570f37a1f3` | pull_request | Huawei MIT source headers | completed:success |
| 35007781040 | `ad570f37a1f3` | pull_request | Hosted portability and native qualification | completed:success |
| 35007781036 | `ad570f37a1f3` | pull_request | Formal assurance | completed:success |
| 35006759427 | `22b3572a448b` | pull_request | Huawei MIT source headers | completed:success |
| 35006759396 | `22b3572a448b` | pull_request | Repository quality | completed:success |
| 35006759371 | `22b3572a448b` | pull_request | Emulated aarch64 portability | completed:success |
| 35006759355 | `22b3572a448b` | pull_request | Hosted portability and native qualification | completed:success |
