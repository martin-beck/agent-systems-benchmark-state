...
| #127 | `fix/mini-swe-cancellation-reap-test-isolation@3393737f5a1b` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | test(agents): harden mini-swe cancellation isolation |
...
| --- | --- | --- | --- | --- |
| 34991323648 | `3393737f5a1b` | pull_request | Huawei MIT source headers | completed:success |
| 34991323611 | `3393737f5a1b` | pull_request | Repository quality | completed:success |
| 34991323558 | `3393737f5a1b` | pull_request | Fault assurance | completed:success |
| 34991323529 | `3393737f5a1b` | pull_request | Rust verification | completed:success |
| 34991323523 | `3393737f5a1b` | pull_request | Emulated aarch64 portability | completed:failure |
| 34991323518 | `3393737f5a1b` | pull_request | Formal assurance | completed:success |
| 34991323512 | `3393737f5a1b` | pull_request | Hosted portability and native qualification | completed:success |
| 34991323493 | `3393737f5a1b` | pull_request | Agent Workflow Quality shadow | completed:success |
