...
| #264 | `feature/ar-1356-control-runtime-attestation-primitive@9e587593c2fd` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS | feat(runtime): bind live enrollment to control attestation |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35922366273 | `9e587593c2fd` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35922366266 | `9e587593c2fd` | pull_request | Hosted portability and native qualification | completed:success |
| 35922366265 | `9e587593c2fd` | pull_request | Repository quality | in_progress:- |
| 35922366246 | `9e587593c2fd` | pull_request | Fault assurance | in_progress:- |
| 35922366231 | `9e587593c2fd` | pull_request | Rust verification | in_progress:- |
| 35922366224 | `9e587593c2fd` | pull_request | Huawei MIT source headers | completed:success |
| 35922366213 | `9e587593c2fd` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35922366184 | `9e587593c2fd` | pull_request | Formal assurance | in_progress:- |
| 35921962247 | `ce7401a2c6e7` | pull_request | Rust verification | completed:cancelled |
| 35921962228 | `ce7401a2c6e7` | pull_request | Fault assurance | completed:success |
| 35921962226 | `ce7401a2c6e7` | pull_request | Emulated aarch64 portability | completed:cancelled |
| 35921962189 | `ce7401a2c6e7` | pull_request | Repository quality | completed:cancelled |
