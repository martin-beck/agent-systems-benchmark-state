...
| #143 | `feature/measurement-selection-plan@819de6934a42` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(metrics): bind selections to run plans |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34565403122 | `819de6934a42` | pull_request | Repository quality | in_progress:- |
| 34565403115 | `819de6934a42` | pull_request | Rust verification | in_progress:- |
