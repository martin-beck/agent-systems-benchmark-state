...
| #191 | `fix/protected-main-admission@9db468cad9fc` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | fix(policy): harden protected merge admission |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35076489657 | `9db468cad9fc` | pull_request | Fault assurance | in_progress:- |
| 35076489631 | `9db468cad9fc` | pull_request | Hosted portability and native qualification | in_progress:- |
| 35076489628 | `9db468cad9fc` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35076489607 | `9db468cad9fc` | pull_request | Repository quality | in_progress:- |
| 35076489582 | `9db468cad9fc` | pull_request | Formal assurance | in_progress:- |
| 35076489580 | `9db468cad9fc` | pull_request | Rust verification | in_progress:- |
| 35076489557 | `9db468cad9fc` | pull_request | Huawei MIT source headers | completed:success |
| 35076489534 | `9db468cad9fc` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35076151220 | `da8d736c8a96` | pull_request | Hosted portability and native qualification | completed:failure |
| 35076151210 | `da8d736c8a96` | pull_request | Repository quality | completed:failure |
| 35076151151 | `da8d736c8a96` | pull_request | Formal assurance | completed:cancelled |
