...
| #136 | `fix/gemini-hook-readiness-race@55648d5a29f4` | `main` | CLEAN | COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | fix: publish Gemini hook readiness atomically |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34550056870 | `55648d5a29f4` | pull_request | Agent Workflow Quality shadow | completed:success |
| 34550056810 | `55648d5a29f4` | pull_request | Huawei MIT source headers | completed:success |
| 34550056784 | `55648d5a29f4` | pull_request | Fault assurance | completed:success |
| 34550056779 | `55648d5a29f4` | pull_request | Emulated aarch64 portability | completed:success |
| 34550056667 | `55648d5a29f4` | pull_request | Repository quality | completed:success |
| 34550056658 | `55648d5a29f4` | pull_request | Formal assurance | completed:success |
| 34550056630 | `55648d5a29f4` | pull_request | Rust verification | completed:success |
| 34550056599 | `55648d5a29f4` | pull_request | Hosted portability and native qualification | completed:success |
...
| 34549021259 | `208682166c7b` | pull_request | Repository quality | completed:success |
