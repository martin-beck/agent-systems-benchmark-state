...
| #184 | `docs/ar-1210-tutorial-contract@c010553b988b` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:FAILURE, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS | feat(tutorials): add offline tutorial contract validator |
...
| 35053887110 | `c010553b988b` | pull_request | Huawei MIT source headers | completed:failure |
| 35053887102 | `c010553b988b` | pull_request | Rust verification | in_progress:- |
| 35053887098 | `c010553b988b` | pull_request | Formal assurance | in_progress:- |
| 35053887090 | `c010553b988b` | pull_request | Hosted portability and native qualification | completed:success |
