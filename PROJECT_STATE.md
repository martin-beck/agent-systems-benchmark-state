...
| #123 | `fix/hosted-runner-evidence-classification@5e58ae5cdbae` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:FAILURE, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS | ci: classify hosted runner evidence honestly |
| #124 | `feature/openjiuwen-live@cceb76f436f8` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:FAILURE, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS | test(agents): qualify pinned OpenJiuwen live execution |
...
| 34393862056 | `cceb76f436f8` | pull_request | Emulated aarch64 portability | in_progress:- |
| 34393862053 | `cceb76f436f8` | pull_request | Formal assurance | completed:failure |
