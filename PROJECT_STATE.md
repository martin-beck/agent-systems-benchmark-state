...
| #298 | `codex/ar-1412-code-generation-controls@d7d035a6c09d` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat(workloads): preserve code-generation control metrics |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 36014722850 | `d7d035a6c09d` | pull_request | Emulated aarch64 portability | pending:- |
| 36014722506 | `d7d035a6c09d` | pull_request | Agent Workflow Quality shadow | in_progress:- |
| 36014722503 | `d7d035a6c09d` | pull_request | Fault assurance | in_progress:- |
| 36014722492 | `d7d035a6c09d` | pull_request | Huawei MIT source headers | in_progress:- |
| 36014722480 | `d7d035a6c09d` | pull_request | Rust verification | in_progress:- |
| 36014722476 | `d7d035a6c09d` | pull_request | Repository quality | pending:- |
| 36014722436 | `d7d035a6c09d` | pull_request | Hosted portability and native qualification | in_progress:- |
| 36014722431 | `d7d035a6c09d` | pull_request | Formal assurance | in_progress:- |
