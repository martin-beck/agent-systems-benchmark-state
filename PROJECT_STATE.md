...
| #177 | `feature/ar-1228-auth-backends-probes@22b3572a448b` | `main` | CLEAN | COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(auth): bind concrete credential resolvers |
...
| 35006759346 | `22b3572a448b` | pull_request | Formal assurance | completed:success |
| 35006759326 | `22b3572a448b` | pull_request | Rust verification | completed:success |
| 35006759315 | `22b3572a448b` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35006759312 | `22b3572a448b` | pull_request | Fault assurance | completed:success |
| 35006345948 | `98733fc1a914` | pull_request | Repository quality | completed:cancelled |
| 35006345908 | `98733fc1a914` | pull_request | Rust verification | completed:cancelled |
| 35006345890 | `98733fc1a914` | pull_request | Fault assurance | completed:success |
| 35006345877 | `98733fc1a914` | pull_request | Huawei MIT source headers | completed:success |
