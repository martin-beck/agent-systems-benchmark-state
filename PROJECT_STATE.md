...
| #136 | `fix/gemini-hook-readiness-race@310873510c6a` | `main` | UNSTABLE | COMPLETED:FAILURE, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | fix: publish Gemini hook readiness atomically |
...
| 34548738518 | `310873510c6a` | pull_request | Emulated aarch64 portability | in_progress:- |
| 34548738516 | `310873510c6a` | pull_request | Rust verification | in_progress:- |
| 34548738488 | `310873510c6a` | pull_request | Repository quality | in_progress:- |
| 34548738464 | `310873510c6a` | pull_request | Huawei MIT source headers | completed:success |
| 34548738416 | `310873510c6a` | pull_request | Fault assurance | completed:success |
| 34548738402 | `310873510c6a` | pull_request | Agent Workflow Quality shadow | completed:success |
| 34548738397 | `310873510c6a` | pull_request | Formal assurance | completed:success |
| 34548496663 | `44eb1b48cb79` | push | Huawei MIT source headers | completed:success |
| 34548483091 | `44eb1b48cb79` | push | Formal assurance | completed:success |
| 34548483088 | `44eb1b48cb79` | push | Emulated aarch64 portability | completed:success |
| 34548483050 | `44eb1b48cb79` | push | Hosted portability and native qualification | completed:success |
