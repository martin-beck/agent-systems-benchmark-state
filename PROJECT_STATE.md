...
- Local origin/main: `03b830bbec183477758877f8a2a9e00714d351c0`
...
| #264 | `feature/ar-1356-control-runtime-attestation-primitive@ce7401a2c6e7` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(runtime): bind live enrollment to control attestation |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35921962247 | `ce7401a2c6e7` | pull_request | Rust verification | in_progress:- |
| 35921962228 | `ce7401a2c6e7` | pull_request | Fault assurance | completed:success |
| 35921962226 | `ce7401a2c6e7` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35921962189 | `ce7401a2c6e7` | pull_request | Repository quality | in_progress:- |
| 35921962161 | `ce7401a2c6e7` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35921962075 | `ce7401a2c6e7` | pull_request | Huawei MIT source headers | completed:success |
| 35921962053 | `ce7401a2c6e7` | pull_request | Formal assurance | in_progress:- |
| 35921962011 | `ce7401a2c6e7` | pull_request | Hosted portability and native qualification | completed:success |
| 35921309050 | `70f8a3980cb0` | pull_request | Rust verification | completed:cancelled |
| 35921309049 | `70f8a3980cb0` | pull_request | Formal assurance | completed:failure |
| 35921309046 | `70f8a3980cb0` | pull_request | Repository quality | completed:failure |
| 35921309038 | `70f8a3980cb0` | pull_request | Agent Workflow Quality shadow | completed:success |
