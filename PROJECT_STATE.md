...
| #136 | `fix/gemini-hook-readiness-race@208682166c7b` | `main` | UNSTABLE | QUEUED:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | fix: publish Gemini hook readiness atomically |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34549021304 | `208682166c7b` | pull_request | Rust verification | pending:- |
...
| 34549021259 | `208682166c7b` | pull_request | Repository quality | pending:- |
| 34549021253 | `208682166c7b` | pull_request | Huawei MIT source headers | completed:success |
| 34549021242 | `208682166c7b` | pull_request | Emulated aarch64 portability | queued:- |
