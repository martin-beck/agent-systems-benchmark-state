...
| #179 | `feature/ar-1229-auth-application-integration@c1d55eee18cb` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat: integrate provider authentication application surfaces |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35034110044 | `c1d55eee18cb` | pull_request | Hosted portability and native qualification | in_progress:- |
| 35034110031 | `c1d55eee18cb` | pull_request | Repository quality | in_progress:- |
...
| 35034109973 | `c1d55eee18cb` | pull_request | Huawei MIT source headers | completed:success |
| 35034109970 | `c1d55eee18cb` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35034109959 | `c1d55eee18cb` | pull_request | Formal assurance | in_progress:- |
| 35034109956 | `c1d55eee18cb` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35033950504 | `0a5ddb1c9895` | pull_request | Formal assurance | completed:cancelled |
| 35033950453 | `0a5ddb1c9895` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35033950447 | `0a5ddb1c9895` | pull_request | Huawei MIT source headers | completed:success |
| 35033950443 | `0a5ddb1c9895` | pull_request | Fault assurance | completed:cancelled |
