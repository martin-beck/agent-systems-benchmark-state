...
| #177 | `feature/ar-1228-auth-backends-probes@c663f5897efd` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED: | feat(auth): bind concrete credential resolvers |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35008131312 | `c663f5897efd` | pull_request | Agent Workflow Quality shadow | queued:- |
| 35008131260 | `c663f5897efd` | pull_request | Repository quality | pending:- |
| 35008131190 | `c663f5897efd` | pull_request | Rust verification | pending:- |
| 35008131109 | `c663f5897efd` | pull_request | Huawei MIT source headers | queued:- |
| 35008130981 | `c663f5897efd` | pull_request | Fault assurance | queued:- |
| 35008130959 | `c663f5897efd` | pull_request | Emulated aarch64 portability | pending:- |
| 35008130949 | `c663f5897efd` | pull_request | Formal assurance | queued:- |
| 35008130912 | `c663f5897efd` | pull_request | Hosted portability and native qualification | queued:- |
