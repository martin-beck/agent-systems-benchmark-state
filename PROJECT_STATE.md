...
| #124 | `feature/openjiuwen-live@230084ef1ea8` | `main` | CLEAN | COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | test(agents): qualify pinned OpenJiuwen live execution |
...
| #186 | `feature/ar-1140@d83be5b7e576` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(cli): add setup preflight and transactional selection |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35068339811 | `230084ef1ea8` | pull_request | Rust verification | completed:success |
| 35068339809 | `230084ef1ea8` | pull_request | Emulated aarch64 portability | completed:success |
| 35068339784 | `230084ef1ea8` | pull_request | Formal assurance | completed:success |
| 35068339781 | `230084ef1ea8` | pull_request | Repository quality | completed:success |
| 35068339775 | `230084ef1ea8` | pull_request | Huawei MIT source headers | completed:success |
| 35068339773 | `230084ef1ea8` | pull_request | Fault assurance | completed:success |
| 35068339772 | `230084ef1ea8` | pull_request | Hosted portability and native qualification | completed:success |
| 35068339768 | `230084ef1ea8` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35068170238 | `fb6a57217033` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35068170184 | `fb6a57217033` | pull_request | Huawei MIT source headers | completed:success |
| 35068170108 | `fb6a57217033` | pull_request | Formal assurance | completed:cancelled |
| 35068169984 | `fb6a57217033` | pull_request | Rust verification | completed:cancelled |
