...
| #185 | `fix/main-merge-integrity-postmerge@e55988819f07` | `main` | UNSTABLE | COMPLETED:FAILURE, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | fix(policy): accept signed local protected merges |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35059195762 | `e55988819f07` | pull_request | Repository quality | completed:failure |
| 35059195759 | `e55988819f07` | pull_request | Fault assurance | completed:success |
| 35059195753 | `e55988819f07` | pull_request | Huawei MIT source headers | completed:success |
| 35059195747 | `e55988819f07` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35059195744 | `e55988819f07` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35059195742 | `e55988819f07` | pull_request | Hosted portability and native qualification | completed:success |
| 35059195739 | `e55988819f07` | pull_request | Rust verification | completed:success |
| 35059195737 | `e55988819f07` | pull_request | Formal assurance | completed:success |
| 35058879949 | `7d43c1ec90fe` | push | Hosted portability and native qualification | completed:success |
| 35058879938 | `7d43c1ec90fe` | push | Rust verification | completed:success |
| 35058879936 | `7d43c1ec90fe` | push | Fault assurance | completed:success |
| 35058879909 | `7d43c1ec90fe` | push | Formal assurance | completed:success |
