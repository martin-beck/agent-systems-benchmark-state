...
| #184 | `docs/ar-1210-tutorial-contract@984b2f8417e2` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:FAILURE, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:FAILURE, COMPLETED:SUCCESS | feat(tutorials): add offline tutorial contract validator |
...
| 35054025955 | `984b2f8417e2` | pull_request | Hosted portability and native qualification | completed:success |
...
| 35053887135 | `c010553b988b` | pull_request | Fault assurance | completed:cancelled |
| 35053887131 | `c010553b988b` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35053887113 | `c010553b988b` | pull_request | Emulated aarch64 portability | completed:cancelled |
