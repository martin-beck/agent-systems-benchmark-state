...
| #298 | `codex/ar-1412-code-generation-controls@0d94a2e87116` | `main` | CLEAN | - | feat(workloads): preserve code-generation control metrics |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 36016158101 | `0d94a2e87116` | pull_request | Rust verification | queued:- |
| 36016158092 | `0d94a2e87116` | pull_request | Agent Workflow Quality shadow | queued:- |
| 36016158090 | `0d94a2e87116` | pull_request | Formal assurance | queued:- |
| 36016158007 | `0d94a2e87116` | pull_request | Emulated aarch64 portability | queued:- |
| 36016157957 | `0d94a2e87116` | pull_request | Hosted portability and native qualification | queued:- |
| 36016157947 | `0d94a2e87116` | pull_request | Repository quality | queued:- |
| 36016157939 | `0d94a2e87116` | pull_request | Huawei MIT source headers | queued:- |
| 36016157935 | `0d94a2e87116` | pull_request | Fault assurance | queued:- |
