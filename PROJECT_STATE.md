...
| --- | --- | --- | --- | --- | --- |
| #316 | `feature/ar-1435-local-mock-cli-wiring@dc52ca99aaea` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | Wire configured run and sweep through local mock attempts |
