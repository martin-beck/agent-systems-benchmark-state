...
| #179 | `feature/ar-1229-auth-application-integration@9c4741f934b3` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat: integrate provider authentication application surfaces |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35031299520 | `9c4741f934b3` | pull_request | Hosted portability and native qualification | completed:success |
| 35031299370 | `9c4741f934b3` | pull_request | Huawei MIT source headers | completed:success |
| 35031299348 | `9c4741f934b3` | pull_request | Formal assurance | completed:success |
| 35031299291 | `9c4741f934b3` | pull_request | Emulated aarch64 portability | completed:success |
| 35031299286 | `9c4741f934b3` | pull_request | Repository quality | completed:failure |
| 35031299256 | `9c4741f934b3` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35031299200 | `9c4741f934b3` | pull_request | Fault assurance | completed:success |
| 35031299157 | `9c4741f934b3` | pull_request | Rust verification | completed:success |
| 35030315939 | `84d008cbc91d` | pull_request | Hosted portability and native qualification | completed:success |
| 35030315884 | `84d008cbc91d` | pull_request | Repository quality | completed:failure |
| 35030315838 | `84d008cbc91d` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35030315826 | `84d008cbc91d` | pull_request | Fault assurance | completed:success |
