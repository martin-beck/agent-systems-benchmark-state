...
| #227 | `feature/ar-1160-control-lifecycle@ce71ffbc3364` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED: | feat(control): add recording campaign lifecycle operations |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35354615315 | `ce71ffbc3364` | pull_request | Formal assurance | queued:- |
| 35354615197 | `ce71ffbc3364` | pull_request | Repository quality | queued:- |
| 35354615177 | `ce71ffbc3364` | pull_request | Emulated aarch64 portability | queued:- |
| 35354615147 | `ce71ffbc3364` | pull_request | Fault assurance | queued:- |
| 35354615117 | `ce71ffbc3364` | pull_request | Agent Workflow Quality shadow | queued:- |
| 35354615101 | `ce71ffbc3364` | pull_request | Hosted portability and native qualification | queued:- |
| 35354615098 | `ce71ffbc3364` | pull_request | Huawei MIT source headers | queued:- |
| 35354615095 | `ce71ffbc3364` | pull_request | Rust verification | queued:- |
