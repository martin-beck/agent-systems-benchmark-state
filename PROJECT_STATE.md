...
| --- | --- | --- | --- | --- | --- |
| #31 | `feature/native-platforms@f919b78da998` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, IN_PROGRESS: | platforms: add fail-closed native qualification evidence |
