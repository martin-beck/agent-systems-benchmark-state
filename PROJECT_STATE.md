...
| #277 | `feature/ar-1381-live-cli-scheduler-wiring@4ba3085e9544` | `main` | UNSTABLE | QUEUED:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat(cli): wire runtime live scheduler |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35955089278 | `4ba3085e9544` | pull_request | Fault assurance | in_progress:- |
...
| 35955089210 | `4ba3085e9544` | pull_request | Hosted portability and native qualification | in_progress:- |
| 35955089209 | `4ba3085e9544` | pull_request | Formal assurance | in_progress:- |
