...
| #176 | `feature/ar-1120@a68b29a53673` | `main` | UNSTABLE | COMPLETED:FAILURE, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS | feat(auth): add credential enrollment lifecycle |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35003911653 | `a68b29a53673` | pull_request | Fault assurance | in_progress:- |
| 35003911577 | `a68b29a53673` | pull_request | Formal assurance | in_progress:- |
| 35003911575 | `a68b29a53673` | pull_request | Repository quality | in_progress:- |
| 35003911569 | `a68b29a53673` | pull_request | Rust verification | completed:failure |
| 35003911532 | `a68b29a53673` | pull_request | Hosted portability and native qualification | completed:success |
| 35003911529 | `a68b29a53673` | pull_request | Huawei MIT source headers | completed:success |
| 35003911528 | `a68b29a53673` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35003911521 | `a68b29a53673` | pull_request | Emulated aarch64 portability | in_progress:- |
