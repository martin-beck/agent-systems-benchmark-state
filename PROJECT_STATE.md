...
| --- | --- | --- | --- | --- |
| 35923506478 | `d4b2054380a4` | pull_request | Formal assurance | completed:failure |
| 35923506464 | `d4b2054380a4` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35923506459 | `d4b2054380a4` | pull_request | Fault assurance | completed:failure |
| 35923506421 | `d4b2054380a4` | pull_request | Huawei MIT source headers | completed:success |
| 35923506405 | `d4b2054380a4` | pull_request | Hosted portability and native qualification | completed:failure |
| 35923506374 | `d4b2054380a4` | pull_request | Emulated aarch64 portability | completed:failure |
| 35923506270 | `d4b2054380a4` | pull_request | Repository quality | completed:failure |
| 35923506260 | `d4b2054380a4` | pull_request | Rust verification | completed:failure |
| 35923427607 | `a6f1915aa511` | dynamic | Dependabot Updates | completed:success |
| 35923315486 | `a6f1915aa511` | push | Hosted portability and native qualification | completed:success |
| 35923315452 | `a6f1915aa511` | push | Emulated aarch64 portability | completed:success |
| 35923315448 | `a6f1915aa511` | push | Huawei MIT source headers | completed:success |
