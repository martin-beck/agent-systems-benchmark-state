...
- Product remote main: `4d4a0c4f3bd71f9884c9cc06649ba6722fa03bff`
...
| #127 | `fix/mini-swe-cancellation-reap-test-isolation@aba1f8cded47` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED: | test(agents): harden mini-swe cancellation isolation |
...
| --- | --- | --- | --- | --- |
| 35056260773 | `aba1f8cded47` | pull_request | Hosted portability and native qualification | queued:- |
| 35056260736 | `aba1f8cded47` | pull_request | Repository quality | queued:- |
| 35056260730 | `aba1f8cded47` | pull_request | Emulated aarch64 portability | queued:- |
| 35056260723 | `aba1f8cded47` | pull_request | Formal assurance | queued:- |
| 35056260715 | `aba1f8cded47` | pull_request | Fault assurance | queued:- |
| 35056260711 | `aba1f8cded47` | pull_request | Huawei MIT source headers | queued:- |
| 35056260707 | `aba1f8cded47` | pull_request | Agent Workflow Quality shadow | in_progress:- |
| 35056260705 | `aba1f8cded47` | pull_request | Rust verification | queued:- |
| 35055701134 | `0e8ee8d47529` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35055701113 | `0e8ee8d47529` | pull_request | Formal assurance | completed:success |
| 35055701091 | `0e8ee8d47529` | pull_request | Fault assurance | completed:success |
| 35055701086 | `0e8ee8d47529` | pull_request | Emulated aarch64 portability | completed:success |
