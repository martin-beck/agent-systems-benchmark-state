...
| #227 | `feature/ar-1160-control-lifecycle@3efbacb6739c` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(control): add recording campaign lifecycle operations |
...
| 35352714992 | `3efbacb6739c` | pull_request | Rust verification | completed:success |
| 35352714980 | `3efbacb6739c` | pull_request | Repository quality | completed:failure |
| 35352714958 | `3efbacb6739c` | pull_request | Formal assurance | completed:success |
