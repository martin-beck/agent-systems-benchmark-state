...
| #260 | `feature/ar-1344-runtime-cli-acquisition-contract@33d3153013d4` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, QUEUED:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, QUEUED:, IN_PROGRESS:, QUEUED:, QUEUED: | Runtime-owned CLI live acquisition factory |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35876973804 | `33d3153013d4` | pull_request | Rust verification | queued:- |
| 35876973790 | `33d3153013d4` | pull_request | Repository quality | in_progress:- |
| 35876973777 | `33d3153013d4` | pull_request | Huawei MIT source headers | in_progress:- |
| 35876973769 | `33d3153013d4` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35876973739 | `33d3153013d4` | pull_request | Hosted portability and native qualification | queued:- |
| 35876973614 | `33d3153013d4` | pull_request | Formal assurance | queued:- |
| 35876973528 | `33d3153013d4` | pull_request | Agent Workflow Quality shadow | queued:- |
| 35876973443 | `33d3153013d4` | pull_request | Fault assurance | queued:- |
