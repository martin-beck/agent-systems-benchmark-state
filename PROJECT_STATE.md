...
| #276 | `feature/ar-1380-runtime-scheduler-composition@ab4e60cb9639` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS: | feat(runtime): compose live scheduler authority |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35952670347 | `ab4e60cb9639` | pull_request | Fault assurance | in_progress:- |
...
| 35952670283 | `ab4e60cb9639` | pull_request | Formal assurance | in_progress:- |
| 35952670269 | `ab4e60cb9639` | pull_request | Repository quality | in_progress:- |
| 35952670268 | `ab4e60cb9639` | pull_request | Rust verification | in_progress:- |
| 35952670252 | `ab4e60cb9639` | pull_request | Hosted portability and native qualification | in_progress:- |
| 35952670208 | `ab4e60cb9639` | pull_request | Emulated aarch64 portability | in_progress:- |
