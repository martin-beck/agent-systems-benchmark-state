...
| #127 | `fix/mini-swe-cancellation-reap-test-isolation@f4a8c5d0847b` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | test(agents): harden mini-swe cancellation isolation |
...
| --- | --- | --- | --- | --- |
| 34997612697 | `f4a8c5d0847b` | pull_request | Rust verification | completed:success |
| 34997612568 | `f4a8c5d0847b` | pull_request | Repository quality | completed:success |
| 34997612542 | `f4a8c5d0847b` | pull_request | Emulated aarch64 portability | completed:failure |
| 34997612513 | `f4a8c5d0847b` | pull_request | Hosted portability and native qualification | completed:success |
| 34997612447 | `f4a8c5d0847b` | pull_request | Fault assurance | completed:success |
| 34997612428 | `f4a8c5d0847b` | pull_request | Agent Workflow Quality shadow | completed:success |
| 34997612422 | `f4a8c5d0847b` | pull_request | Formal assurance | completed:success |
| 34997612385 | `f4a8c5d0847b` | pull_request | Huawei MIT source headers | completed:success |
| 34994676709 | `37c1a08e3dc1` | pull_request | Agent Workflow Quality shadow | completed:success |
| 34994676659 | `37c1a08e3dc1` | pull_request | Hosted portability and native qualification | completed:success |
| 34994676572 | `37c1a08e3dc1` | pull_request | Emulated aarch64 portability | completed:failure |
| 34994676520 | `37c1a08e3dc1` | pull_request | Huawei MIT source headers | completed:success |
