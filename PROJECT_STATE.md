...
| #186 | `feature/ar-1140@1e3212baf22c` | `main` | CLEAN | - | feat(cli): add setup preflight and transactional selection |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35069679184 | `1e3212baf22c` | pull_request | Formal assurance | queued:- |
| 35069679181 | `1e3212baf22c` | pull_request | Fault assurance | queued:- |
| 35069679160 | `1e3212baf22c` | pull_request | Repository quality | queued:- |
| 35069679122 | `1e3212baf22c` | pull_request | Hosted portability and native qualification | queued:- |
| 35069679083 | `1e3212baf22c` | pull_request | Huawei MIT source headers | queued:- |
| 35069679072 | `1e3212baf22c` | pull_request | Emulated aarch64 portability | queued:- |
| 35069679064 | `1e3212baf22c` | pull_request | Rust verification | queued:- |
| 35069679062 | `1e3212baf22c` | pull_request | Agent Workflow Quality shadow | queued:- |
