...
- Local origin/main: `17a1530e620608a4d53b6d92ba48c642400778e2`
...
| --- | --- | --- | --- | --- | --- |
| #119 | `feature/native-capacity-controller@c5a7b5a0448c` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS | feat(capacity): add bounded native lifecycle controller |
...
| #230 | `repair/ar-1313-runner-routing-forward-revalidation@27fbefc436df` | `main` | CLEAN | COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | docs: clarify required runner evidence routing |
...
| 35398910299 | `c5a7b5a0448c` | pull_request | Fault assurance | in_progress:- |
...
| 35398910254 | `c5a7b5a0448c` | pull_request | Formal assurance | in_progress:- |
| 35398910230 | `c5a7b5a0448c` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35398910227 | `c5a7b5a0448c` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35398910222 | `c5a7b5a0448c` | pull_request | Rust verification | in_progress:- |
| 35398398885 | `27fbefc436df` | pull_request | Fault assurance | completed:success |
| 35398398849 | `27fbefc436df` | pull_request | Formal assurance | completed:success |
| 35398398758 | `27fbefc436df` | pull_request | Emulated aarch64 portability | completed:success |
| 35398398718 | `27fbefc436df` | pull_request | Hosted portability and native qualification | completed:success |
