...
| --- | --- | --- | --- | --- | --- |
| #119 | `feature/native-capacity-controller@c5a7b5a0448c` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat(capacity): add bounded native lifecycle controller |
...
| #230 | `repair/ar-1313-runner-routing-forward-revalidation@27fbefc436df` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | docs: clarify required runner evidence routing |
...
| 35398910268 | `c5a7b5a0448c` | pull_request | Hosted portability and native qualification | in_progress:- |
