...
| #229 | `feature/ar-1310-provider-capture-campaign@a6a3e43cce68` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED: | feat: qualify runtime provider capture campaigns |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35390406888 | `a6a3e43cce68` | pull_request | Huawei MIT source headers | in_progress:- |
| 35390406870 | `a6a3e43cce68` | pull_request | Fault assurance | queued:- |
| 35390406740 | `a6a3e43cce68` | pull_request | Formal assurance | queued:- |
| 35390406607 | `a6a3e43cce68` | pull_request | Agent Workflow Quality shadow | in_progress:- |
| 35390406567 | `a6a3e43cce68` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35390406546 | `a6a3e43cce68` | pull_request | Rust verification | in_progress:- |
| 35390406545 | `a6a3e43cce68` | pull_request | Hosted portability and native qualification | queued:- |
| 35390406423 | `a6a3e43cce68` | pull_request | Repository quality | in_progress:- |
