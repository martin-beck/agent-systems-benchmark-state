...
| --- | --- | --- | --- | --- | --- |
| #316 | `feature/ar-1435-local-mock-cli-wiring@8a4ab336b89b` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS | Wire configured run and sweep through local mock attempts |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 36076453046 | `8a4ab336b89b` | pull_request | Rust verification | in_progress:- |
