...
| #178 | `feature/ar-1230-authenticated-provider-request-seam@a681768a6930` | `main` | CLEAN | - | feat(auth): add authenticated provider request seam |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35015053694 | `a681768a6930` | pull_request | Fault assurance | queued:- |
| 35015053556 | `a681768a6930` | pull_request | Hosted portability and native qualification | queued:- |
| 35015053512 | `a681768a6930` | pull_request | Formal assurance | queued:- |
| 35015053486 | `a681768a6930` | pull_request | Agent Workflow Quality shadow | queued:- |
| 35015053457 | `a681768a6930` | pull_request | Repository quality | pending:- |
| 35015053443 | `a681768a6930` | pull_request | Huawei MIT source headers | queued:- |
| 35015053409 | `a681768a6930` | pull_request | Emulated aarch64 portability | pending:- |
| 35015053397 | `a681768a6930` | pull_request | Rust verification | pending:- |
