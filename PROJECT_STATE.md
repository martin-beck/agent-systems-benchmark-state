...
| --- | --- | --- | --- | --- | --- |
| #119 | `feature/native-capacity-controller@4630f90af739` | `main` | UNSTABLE | COMPLETED:CANCELLED, COMPLETED:CANCELLED, COMPLETED:CANCELLED, COMPLETED:CANCELLED, COMPLETED:CANCELLED, QUEUED:, QUEUED:, QUEUED:, QUEUED:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:CANCELLED, COMPLETED:CANCELLED, QUEUED:, QUEUED:, COMPLETED:CANCELLED, COMPLETED:CANCELLED, QUEUED:, QUEUED: | feat(capacity): add bounded native lifecycle controller |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 36051011863 | `4630f90af739` | pull_request | Repository quality | queued:- |
| 36051011847 | `4630f90af739` | pull_request | Emulated aarch64 portability | queued:- |
| 36051011795 | `4630f90af739` | pull_request | Fault assurance | queued:- |
| 36051011749 | `4630f90af739` | pull_request | Formal assurance | queued:- |
...
| 36051011579 | `4630f90af739` | pull_request | Rust verification | queued:- |
