...
| #178 | `feature/ar-1230-authenticated-provider-request-seam@07b670ded6be` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(auth): add authenticated provider request seam |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35014613474 | `07b670ded6be` | pull_request | Rust verification | in_progress:- |
| 35014613432 | `07b670ded6be` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35014613424 | `07b670ded6be` | pull_request | Formal assurance | completed:success |
| 35014613410 | `07b670ded6be` | pull_request | Repository quality | in_progress:- |
| 35014613407 | `07b670ded6be` | pull_request | Huawei MIT source headers | completed:success |
| 35014613405 | `07b670ded6be` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35014613402 | `07b670ded6be` | pull_request | Fault assurance | completed:success |
| 35014613398 | `07b670ded6be` | pull_request | Hosted portability and native qualification | completed:success |
| 35014237589 | `e1a5c1d6dac0` | pull_request | Huawei MIT source headers | completed:success |
| 35014237473 | `e1a5c1d6dac0` | pull_request | Rust verification | completed:cancelled |
| 35014237362 | `e1a5c1d6dac0` | pull_request | Repository quality | completed:cancelled |
| 35014237049 | `e1a5c1d6dac0` | pull_request | Hosted portability and native qualification | completed:success |
