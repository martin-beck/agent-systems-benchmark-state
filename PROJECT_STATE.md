...
| #225 | `feature/ar-1151-followup@20db76eaf55c` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat(control): expose authenticated provider model catalog |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35343883084 | `20db76eaf55c` | pull_request | Rust verification | in_progress:- |
| 35343883078 | `20db76eaf55c` | pull_request | Fault assurance | in_progress:- |
| 35343883043 | `20db76eaf55c` | pull_request | Hosted portability and native qualification | completed:success |
| 35343883027 | `20db76eaf55c` | pull_request | Formal assurance | in_progress:- |
| 35343883006 | `20db76eaf55c` | pull_request | Huawei MIT source headers | completed:success |
| 35343882995 | `20db76eaf55c` | pull_request | Repository quality | in_progress:- |
| 35343882965 | `20db76eaf55c` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35343882905 | `20db76eaf55c` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35343758177 | `a6d8fbd6986e` | pull_request | Hosted portability and native qualification | completed:success |
| 35343757769 | `a6d8fbd6986e` | pull_request | Formal assurance | completed:cancelled |
| 35343757675 | `a6d8fbd6986e` | pull_request | Emulated aarch64 portability | completed:cancelled |
| 35343757535 | `a6d8fbd6986e` | pull_request | Agent Workflow Quality shadow | completed:success |
