...
| #225 | `feature/ar-1151-followup@8cb9553519df` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:FAILURE, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat(control): expose authenticated provider model catalog |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35341892363 | `8cb9553519df` | pull_request | Fault assurance | in_progress:- |
...
| 35341892318 | `8cb9553519df` | pull_request | Formal assurance | in_progress:- |
