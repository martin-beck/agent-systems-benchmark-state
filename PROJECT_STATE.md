...
| #185 | `fix/main-merge-integrity-postmerge@df5a519b8b76` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED: | fix(policy): accept signed local protected merges |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35059756710 | `df5a519b8b76` | pull_request | Huawei MIT source headers | queued:- |
| 35059756438 | `df5a519b8b76` | pull_request | Rust verification | queued:- |
| 35059756431 | `df5a519b8b76` | pull_request | Hosted portability and native qualification | queued:- |
| 35059756418 | `df5a519b8b76` | pull_request | Fault assurance | queued:- |
| 35059756379 | `df5a519b8b76` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35059756372 | `df5a519b8b76` | pull_request | Agent Workflow Quality shadow | queued:- |
| 35059756325 | `df5a519b8b76` | pull_request | Repository quality | queued:- |
| 35059756324 | `df5a519b8b76` | pull_request | Formal assurance | queued:- |
