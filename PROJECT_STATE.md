...
| #177 | `feature/ar-1228-auth-backends-probes@cdfd81cb55f5` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED: | feat(auth): bind concrete credential resolvers |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35022991403 | `cdfd81cb55f5` | pull_request | Hosted portability and native qualification | queued:- |
| 35022991332 | `cdfd81cb55f5` | pull_request | Rust verification | pending:- |
| 35022991321 | `cdfd81cb55f5` | pull_request | Fault assurance | queued:- |
| 35022991317 | `cdfd81cb55f5` | pull_request | Agent Workflow Quality shadow | queued:- |
| 35022991265 | `cdfd81cb55f5` | pull_request | Formal assurance | pending:- |
| 35022991259 | `cdfd81cb55f5` | pull_request | Huawei MIT source headers | in_progress:- |
| 35022991258 | `cdfd81cb55f5` | pull_request | Repository quality | pending:- |
| 35022991247 | `cdfd81cb55f5` | pull_request | Emulated aarch64 portability | pending:- |
