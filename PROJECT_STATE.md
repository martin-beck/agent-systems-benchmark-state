...
| #179 | `feature/ar-1229-auth-application-integration@b85d07860472` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED: | feat: integrate provider authentication application surfaces |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35031720382 | `b85d07860472` | pull_request | Fault assurance | queued:- |
| 35031720379 | `b85d07860472` | pull_request | Rust verification | queued:- |
| 35031720376 | `b85d07860472` | pull_request | Hosted portability and native qualification | queued:- |
| 35031720374 | `b85d07860472` | pull_request | Formal assurance | queued:- |
| 35031720364 | `b85d07860472` | pull_request | Agent Workflow Quality shadow | in_progress:- |
| 35031720363 | `b85d07860472` | pull_request | Emulated aarch64 portability | queued:- |
| 35031720361 | `b85d07860472` | pull_request | Huawei MIT source headers | queued:- |
| 35031720358 | `b85d07860472` | pull_request | Repository quality | queued:- |
