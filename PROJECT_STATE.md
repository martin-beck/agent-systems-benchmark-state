...
| #127 | `fix/mini-swe-cancellation-reap-test-isolation@23c6ed5bb645` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:FAILURE, COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | test(agents): harden mini-swe cancellation isolation |
...
| 34450494641 | `23c6ed5bb645` | pull_request | Formal assurance | completed:failure |
| 34450494614 | `23c6ed5bb645` | pull_request | Agent Workflow Quality shadow | completed:success |
| 34450494606 | `23c6ed5bb645` | pull_request | Emulated aarch64 portability | completed:failure |
| 34450494592 | `23c6ed5bb645` | pull_request | Repository quality | completed:success |
| 34448590475 | `eefdb833248d` | pull_request | Rust verification | completed:success |
| 34448590456 | `eefdb833248d` | pull_request | Fault assurance | completed:success |
| 34448590449 | `eefdb833248d` | pull_request | Formal assurance | completed:failure |
| 34448590439 | `eefdb833248d` | pull_request | Native platform evidence | completed:success |
