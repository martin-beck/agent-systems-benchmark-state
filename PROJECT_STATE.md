...
- Product remote main: `9db4b6d74d4442354f8bf29a46f3ab38f38f36db`
- Local origin/main: `9db4b6d74d4442354f8bf29a46f3ab38f38f36db`
- Primary worktree head: `9db4b6d74d4442354f8bf29a46f3ab38f38f36db`

## Open pull requests

| PR | Head | Base | Merge | Checks | Title |
| --- | --- | --- | --- | --- | --- |
| #5 | `feature/platform-manifests@a800ca3b9169` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | platforms: pin initial support manifests |
| #6 | `feature/durable-results@f6cd02eef6b7` | `main` | CLEAN | COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | Add crash-consistent durable result storage |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34047347503 | `a800ca3b9169` | pull_request | Rust verification | in_progress:- |
| 34047347454 | `a800ca3b9169` | pull_request | Repository quality | in_progress:- |
