...
| #126 | `fix/main-merge-integrity@bd6f450ab877` | `main` | UNSTABLE | COMPLETED:FAILURE, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS | tools: harden signed merge publication |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34406581994 | `bd6f450ab877` | pull_request | Repository quality | in_progress:- |
| 34406581954 | `bd6f450ab877` | pull_request | Fault assurance | in_progress:- |
| 34406581867 | `bd6f450ab877` | pull_request | Huawei MIT source headers | completed:success |
| 34406581827 | `bd6f450ab877` | pull_request | Emulated aarch64 portability | in_progress:- |
| 34406581823 | `bd6f450ab877` | pull_request | Formal assurance | completed:failure |
| 34406581800 | `bd6f450ab877` | pull_request | Native platform evidence | completed:success |
| 34406581791 | `bd6f450ab877` | pull_request | Rust verification | in_progress:- |
| 34406581790 | `bd6f450ab877` | pull_request | Agent Workflow Quality shadow | completed:success |
