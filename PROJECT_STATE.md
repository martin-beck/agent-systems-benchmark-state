...
| #183 | `feature/ar-1231@b62255428989` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(replay): add typed strict launch contract |
...
| 35048475266 | `b62255428989` | pull_request | Repository quality | in_progress:- |
| 35048475259 | `b62255428989` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35048475246 | `b62255428989` | pull_request | Rust verification | in_progress:- |
| 35048475239 | `b62255428989` | pull_request | Fault assurance | completed:success |
| 35048475233 | `b62255428989` | pull_request | Huawei MIT source headers | completed:success |
| 35048475231 | `b62255428989` | pull_request | Formal assurance | completed:success |
| 35048475215 | `b62255428989` | pull_request | Hosted portability and native qualification | completed:success |
