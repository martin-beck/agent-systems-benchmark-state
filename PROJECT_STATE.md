...
| #219 | `feature/ar-1301-replay-lifecycle-fault-matrix@ba2b20dd8a6f` | `main` | UNSTABLE | COMPLETED:FAILURE, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | test(runtime): qualify supervised replay lifecycle fault matrix |
...
| 35218019878 | `ba2b20dd8a6f` | pull_request | Rust verification | in_progress:- |
...
| 35218019820 | `ba2b20dd8a6f` | pull_request | Hosted portability and native qualification | completed:failure |
| 35218019801 | `ba2b20dd8a6f` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35218019776 | `ba2b20dd8a6f` | pull_request | Repository quality | in_progress:- |
| 35218019710 | `ba2b20dd8a6f` | pull_request | Formal assurance | completed:success |
...
| 35217609688 | `d960dfcbaa69` | pull_request | Formal assurance | completed:cancelled |
