...
| #232 | `feature/ar-1314-optional-bundle-signing@c481a409a9cc` | `main` | UNSTABLE | COMPLETED:FAILURE, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(bundle): add explicit unsigned profiles |
...
| #285 | `feature/ar-1395-literature-workload-adapters@475cc806c4e6` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:FAILURE, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS | feat(workloads): add literature workload adapter boundary |
...
| 35978011404 | `475cc806c4e6` | pull_request | Formal assurance | in_progress:- |
| 35978011389 | `475cc806c4e6` | pull_request | Rust verification | in_progress:- |
| 35978011373 | `475cc806c4e6` | pull_request | Fault assurance | in_progress:- |
| 35978011263 | `475cc806c4e6` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35978011210 | `475cc806c4e6` | pull_request | Repository quality | completed:failure |
| 35978011199 | `475cc806c4e6` | pull_request | Huawei MIT source headers | completed:success |
| 35978011155 | `475cc806c4e6` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35977791559 | `c481a409a9cc` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35977791538 | `c481a409a9cc` | pull_request | Formal assurance | completed:success |
| 35977791521 | `c481a409a9cc` | pull_request | Rust verification | in_progress:- |
| 35977791511 | `c481a409a9cc` | pull_request | Fault assurance | completed:success |
