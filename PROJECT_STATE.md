...
| #222 | `feature/ar-1306-authenticated-fault-matrix-qualification@1a22bc65dbd7` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | test(runtime): authenticate fault matrix relay |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35284644568 | `1a22bc65dbd7` | pull_request | Repository quality | in_progress:- |
| 35284644520 | `1a22bc65dbd7` | pull_request | Formal assurance | in_progress:- |
| 35284644514 | `1a22bc65dbd7` | pull_request | Rust verification | in_progress:- |
| 35284644494 | `1a22bc65dbd7` | pull_request | Fault assurance | in_progress:- |
