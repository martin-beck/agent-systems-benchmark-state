...
| #124 | `feature/openjiuwen-live@fb6a57217033` | `main` | UNSTABLE | COMPLETED:FAILURE, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS | test(agents): qualify pinned OpenJiuwen live execution |
...
| 35068170108 | `fb6a57217033` | pull_request | Formal assurance | in_progress:- |
| 35068169984 | `fb6a57217033` | pull_request | Rust verification | in_progress:- |
| 35068169929 | `fb6a57217033` | pull_request | Fault assurance | in_progress:- |
| 35068169917 | `fb6a57217033` | pull_request | Hosted portability and native qualification | completed:failure |
| 35068169830 | `fb6a57217033` | pull_request | Repository quality | in_progress:- |
| 35068169793 | `fb6a57217033` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35066922788 | `d83be5b7e576` | pull_request | Huawei MIT source headers | completed:success |
| 35066922735 | `d83be5b7e576` | pull_request | Fault assurance | completed:success |
| 35066922730 | `d83be5b7e576` | pull_request | Repository quality | completed:failure |
| 35066922700 | `d83be5b7e576` | pull_request | Formal assurance | completed:success |
