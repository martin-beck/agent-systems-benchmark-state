...
| #147 | `dependabot/cargo/sha2-0.11.0@46b7cc5668b3` | `main` | DIRTY | COMPLETED:FAILURE, COMPLETED:FAILURE, COMPLETED:FAILURE, COMPLETED:FAILURE, COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:FAILURE, COMPLETED:FAILURE, COMPLETED:FAILURE, COMPLETED:FAILURE | build(deps): Bump sha2 from 0.10.9 to 0.11.0 |
...
| #151 | `dependabot/cargo/serde-1.0.229@c926edfde377` | `main` | DIRTY | COMPLETED:FAILURE, COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:FAILURE, COMPLETED:SUCCESS | chore(deps): bump serde from 1.0.219 to 1.0.229 |
...
| --- | --- | --- | --- | --- |
| 35122682670 | `14b604fec262` | push | Repository quality | in_progress:- |
| 35122682569 | `14b604fec262` | push | Hosted portability and native qualification | in_progress:- |
| 35122682415 | `14b604fec262` | push | Emulated aarch64 portability | in_progress:- |
| 35122682399 | `14b604fec262` | push | Formal assurance | in_progress:- |
| 35122682366 | `14b604fec262` | push | Rust verification | in_progress:- |
| 35122682280 | `14b604fec262` | push | Huawei MIT source headers | completed:success |
| 35122682278 | `14b604fec262` | push | Fault assurance | in_progress:- |
