...
| #216 | `feature/ar-1287-delegated-sandbox-runner@dba5f9bb6973` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS | tools: add fail-closed delegated replay runner payload |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35192668363 | `dba5f9bb6973` | pull_request | Formal assurance | in_progress:- |
| 35192668332 | `dba5f9bb6973` | pull_request | Rust verification | in_progress:- |
| 35192668331 | `dba5f9bb6973` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35192668310 | `dba5f9bb6973` | pull_request | Repository quality | in_progress:- |
| 35192668266 | `dba5f9bb6973` | pull_request | Huawei MIT source headers | completed:success |
| 35192668255 | `dba5f9bb6973` | pull_request | Fault assurance | in_progress:- |
| 35192668252 | `dba5f9bb6973` | pull_request | Hosted portability and native qualification | completed:success |
| 35192668245 | `dba5f9bb6973` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35192287973 | `afa36923d9cc` | pull_request | Fault assurance | completed:success |
| 35192287958 | `afa36923d9cc` | pull_request | Emulated aarch64 portability | completed:cancelled |
