...
| #132 | `test/capability-coverage-sink@69888a33cdf8` | `main` | CLEAN | COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | test(cli): preserve external coverage sink |
| #135 | `fix/protected-merge-signature-policy@d6fa883ad1b2` | `main` | UNSTABLE | QUEUED:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | fix: verify protected GitHub merges offline |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34546660422 | `d6fa883ad1b2` | pull_request | Rust verification | in_progress:- |
| 34546660119 | `d6fa883ad1b2` | pull_request | Fault assurance | in_progress:- |
| 34546660089 | `d6fa883ad1b2` | pull_request | Repository quality | in_progress:- |
| 34546660032 | `d6fa883ad1b2` | pull_request | Formal assurance | in_progress:- |
| 34546660029 | `d6fa883ad1b2` | pull_request | Huawei MIT source headers | completed:success |
| 34546660022 | `d6fa883ad1b2` | pull_request | Emulated aarch64 portability | in_progress:- |
| 34546660014 | `d6fa883ad1b2` | pull_request | Hosted portability and native qualification | in_progress:- |
| 34546660013 | `d6fa883ad1b2` | pull_request | Agent Workflow Quality shadow | completed:success |
