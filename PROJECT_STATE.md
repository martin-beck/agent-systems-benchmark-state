...
| #177 | `feature/ar-1228-auth-backends-probes@0a5927c6219e` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(auth): bind concrete credential resolvers |
...
| 35025315139 | `0a5927c6219e` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35025315138 | `0a5927c6219e` | pull_request | Hosted portability and native qualification | completed:success |
| 35025315111 | `0a5927c6219e` | pull_request | Formal assurance | completed:success |
| 35025315092 | `0a5927c6219e` | pull_request | Rust verification | completed:success |
