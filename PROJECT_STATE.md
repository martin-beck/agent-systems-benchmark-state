...
| #291 | `codex/ar-1405-dependency-reconcile@a7051c5a72c7` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | chore(deps): refresh safe dependency updates on current main |
...
| 35995209127 | `a7051c5a72c7` | pull_request | Repository quality | in_progress:- |
| 35995209115 | `a7051c5a72c7` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35995209105 | `a7051c5a72c7` | pull_request | Rust verification | in_progress:- |
| 35995209101 | `a7051c5a72c7` | pull_request | Fault assurance | completed:failure |
| 35995209096 | `a7051c5a72c7` | pull_request | Hosted portability and native qualification | completed:success |
| 35995209090 | `a7051c5a72c7` | pull_request | Huawei MIT source headers | completed:success |
| 35995209081 | `a7051c5a72c7` | pull_request | Formal assurance | in_progress:- |
| 35994708482 | `cec3015046bb` | pull_request | Rust verification | completed:cancelled |
