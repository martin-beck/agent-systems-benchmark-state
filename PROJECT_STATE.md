...
| #177 | `feature/ar-1228-auth-backends-probes@a53dcdd27f74` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS | feat(auth): bind concrete credential resolvers |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35022715637 | `a53dcdd27f74` | pull_request | Hosted portability and native qualification | completed:success |
| 35022715605 | `a53dcdd27f74` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35022715543 | `a53dcdd27f74` | pull_request | Formal assurance | in_progress:- |
| 35022715521 | `a53dcdd27f74` | pull_request | Repository quality | in_progress:- |
| 35022715485 | `a53dcdd27f74` | pull_request | Rust verification | in_progress:- |
| 35022715478 | `a53dcdd27f74` | pull_request | Huawei MIT source headers | completed:success |
| 35022715473 | `a53dcdd27f74` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35022715429 | `a53dcdd27f74` | pull_request | Fault assurance | in_progress:- |
| 35022542033 | `339cb283272a` | pull_request | Huawei MIT source headers | completed:success |
| 35022542005 | `339cb283272a` | pull_request | Fault assurance | completed:cancelled |
| 35022541985 | `339cb283272a` | pull_request | Emulated aarch64 portability | completed:cancelled |
| 35022541967 | `339cb283272a` | pull_request | Rust verification | completed:cancelled |
