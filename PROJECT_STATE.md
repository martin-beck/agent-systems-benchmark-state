...
| #177 | `feature/ar-1228-auth-backends-probes@22b3572a448b` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED: | feat(auth): bind concrete credential resolvers |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35006759427 | `22b3572a448b` | pull_request | Huawei MIT source headers | queued:- |
| 35006759396 | `22b3572a448b` | pull_request | Repository quality | pending:- |
| 35006759371 | `22b3572a448b` | pull_request | Emulated aarch64 portability | pending:- |
| 35006759355 | `22b3572a448b` | pull_request | Hosted portability and native qualification | queued:- |
| 35006759346 | `22b3572a448b` | pull_request | Formal assurance | queued:- |
| 35006759326 | `22b3572a448b` | pull_request | Rust verification | pending:- |
| 35006759315 | `22b3572a448b` | pull_request | Agent Workflow Quality shadow | queued:- |
| 35006759312 | `22b3572a448b` | pull_request | Fault assurance | queued:- |
