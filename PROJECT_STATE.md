...
| #132 | `test/capability-coverage-sink@297895dbdee6` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | test(cli): preserve external coverage sink |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34548057685 | `297895dbdee6` | pull_request | Repository quality | in_progress:- |
| 34548057663 | `297895dbdee6` | pull_request | Emulated aarch64 portability | in_progress:- |
...
| 34548057440 | `297895dbdee6` | pull_request | Fault assurance | completed:success |
| 34548057347 | `297895dbdee6` | pull_request | Rust verification | in_progress:- |
