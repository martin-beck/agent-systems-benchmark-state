...
| #123 | `fix/hosted-runner-evidence-classification@5e58ae5cdbae` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | ci: classify hosted runner evidence honestly |
| #124 | `feature/openjiuwen-live@cceb76f436f8` | `main` | CLEAN | QUEUED: | test(agents): qualify pinned OpenJiuwen live execution |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34393862356 | `cceb76f436f8` | pull_request | Rust verification | queued:- |
| 34393862230 | `cceb76f436f8` | pull_request | Repository quality | queued:- |
| 34393862222 | `cceb76f436f8` | pull_request | Native platform evidence | queued:- |
| 34393862216 | `cceb76f436f8` | pull_request | Agent Workflow Quality shadow | queued:- |
| 34393862124 | `cceb76f436f8` | pull_request | Fault assurance | queued:- |
| 34393862085 | `cceb76f436f8` | pull_request | Huawei MIT source headers | queued:- |
| 34393862056 | `cceb76f436f8` | pull_request | Emulated aarch64 portability | queued:- |
| 34393862053 | `cceb76f436f8` | pull_request | Formal assurance | queued:- |
| 34393842258 | `5e58ae5cdbae` | pull_request | Agent Workflow Quality shadow | completed:success |
| 34393842197 | `5e58ae5cdbae` | pull_request | Repository quality | in_progress:- |
| 34393842137 | `5e58ae5cdbae` | pull_request | Emulated aarch64 portability | in_progress:- |
| 34393842126 | `5e58ae5cdbae` | pull_request | Fault assurance | in_progress:- |
