...
| #227 | `feature/ar-1160-control-lifecycle@ce71ffbc3364` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat(control): add recording campaign lifecycle operations |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35354615315 | `ce71ffbc3364` | pull_request | Formal assurance | in_progress:- |
| 35354615197 | `ce71ffbc3364` | pull_request | Repository quality | in_progress:- |
| 35354615177 | `ce71ffbc3364` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35354615147 | `ce71ffbc3364` | pull_request | Fault assurance | in_progress:- |
| 35354615117 | `ce71ffbc3364` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35354615101 | `ce71ffbc3364` | pull_request | Hosted portability and native qualification | in_progress:- |
| 35354615098 | `ce71ffbc3364` | pull_request | Huawei MIT source headers | completed:success |
| 35354615095 | `ce71ffbc3364` | pull_request | Rust verification | in_progress:- |
