...
| #176 | `feature/ar-1120@a68b29a53673` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED: | feat(auth): add credential enrollment lifecycle |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35003911653 | `a68b29a53673` | pull_request | Fault assurance | queued:- |
| 35003911577 | `a68b29a53673` | pull_request | Formal assurance | queued:- |
| 35003911575 | `a68b29a53673` | pull_request | Repository quality | queued:- |
| 35003911569 | `a68b29a53673` | pull_request | Rust verification | queued:- |
| 35003911532 | `a68b29a53673` | pull_request | Hosted portability and native qualification | queued:- |
| 35003911529 | `a68b29a53673` | pull_request | Huawei MIT source headers | queued:- |
| 35003911528 | `a68b29a53673` | pull_request | Agent Workflow Quality shadow | queued:- |
| 35003911521 | `a68b29a53673` | pull_request | Emulated aarch64 portability | queued:- |
