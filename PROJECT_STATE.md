...
| #179 | `feature/ar-1229-auth-application-integration@84d008cbc91d` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat: integrate provider authentication application surfaces |
...
| 35030315811 | `84d008cbc91d` | pull_request | Formal assurance | completed:success |
| 35030315810 | `84d008cbc91d` | pull_request | Rust verification | completed:failure |
| 35030315807 | `84d008cbc91d` | pull_request | Emulated aarch64 portability | completed:success |
| 35030315788 | `84d008cbc91d` | pull_request | Huawei MIT source headers | completed:success |
| 35029861586 | `c705dfe9a513` | pull_request | Hosted portability and native qualification | completed:success |
| 35029861542 | `c705dfe9a513` | pull_request | Huawei MIT source headers | completed:success |
| 35029861526 | `c705dfe9a513` | pull_request | Repository quality | completed:failure |
| 35029861454 | `c705dfe9a513` | pull_request | Rust verification | completed:success |
