...
| #178 | `feature/ar-1230-authenticated-provider-request-seam@2a74205ce8a0` | `main` | CLEAN | COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(auth): add authenticated provider request seam |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35011365142 | `2a74205ce8a0` | pull_request | Formal assurance | completed:success |
| 35011365141 | `2a74205ce8a0` | pull_request | Emulated aarch64 portability | completed:success |
| 35011365119 | `2a74205ce8a0` | pull_request | Huawei MIT source headers | completed:success |
| 35011365108 | `2a74205ce8a0` | pull_request | Fault assurance | completed:success |
| 35011365099 | `2a74205ce8a0` | pull_request | Repository quality | completed:success |
| 35011365098 | `2a74205ce8a0` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35011365092 | `2a74205ce8a0` | pull_request | Hosted portability and native qualification | completed:success |
| 35011365084 | `2a74205ce8a0` | pull_request | Rust verification | completed:success |
| 35010809212 | `d4a102f535c0` | pull_request | Repository quality | completed:cancelled |
| 35010809169 | `d4a102f535c0` | pull_request | Huawei MIT source headers | completed:success |
| 35010809094 | `d4a102f535c0` | pull_request | Emulated aarch64 portability | completed:success |
| 35010809040 | `d4a102f535c0` | pull_request | Hosted portability and native qualification | completed:success |
