...
| #127 | `fix/mini-swe-cancellation-reap-test-isolation@a4dd0941d71f` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | test(agents): harden mini-swe cancellation isolation |
...
| --- | --- | --- | --- | --- |
| 35054743630 | `4d4a0c4f3bd7` | push | Emulated aarch64 portability | completed:success |
| 35054743617 | `4d4a0c4f3bd7` | push | Fault assurance | completed:success |
| 35054743614 | `4d4a0c4f3bd7` | push | Rust verification | completed:failure |
| 35054743606 | `4d4a0c4f3bd7` | push | Repository quality | completed:failure |
| 35054743596 | `4d4a0c4f3bd7` | push | Formal assurance | completed:success |
| 35054743595 | `4d4a0c4f3bd7` | push | Hosted portability and native qualification | completed:success |
| 35054743594 | `4d4a0c4f3bd7` | push | Huawei MIT source headers | completed:success |
...
| 35054477311 | `a4dd0941d71f` | pull_request | Rust verification | completed:success |
