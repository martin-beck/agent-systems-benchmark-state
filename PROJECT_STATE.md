...
| #127 | `fix/mini-swe-cancellation-reap-test-isolation@d82b5123f9d9` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | test(agents): harden mini-swe cancellation isolation |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34451234533 | `d82b5123f9d9` | pull_request | Rust verification | completed:success |
| 34451234506 | `d82b5123f9d9` | pull_request | Emulated aarch64 portability | completed:failure |
| 34451234503 | `d82b5123f9d9` | pull_request | Huawei MIT source headers | completed:success |
| 34451234501 | `d82b5123f9d9` | pull_request | Native platform evidence | completed:success |
| 34451234499 | `d82b5123f9d9` | pull_request | Formal assurance | completed:failure |
| 34451234497 | `d82b5123f9d9` | pull_request | Fault assurance | completed:success |
| 34451234496 | `d82b5123f9d9` | pull_request | Repository quality | completed:success |
| 34451234494 | `d82b5123f9d9` | pull_request | Agent Workflow Quality shadow | completed:success |
| 34450494779 | `23c6ed5bb645` | pull_request | Native platform evidence | completed:failure |
| 34450494757 | `23c6ed5bb645` | pull_request | Rust verification | completed:success |
| 34450494726 | `23c6ed5bb645` | pull_request | Fault assurance | completed:success |
| 34450494646 | `23c6ed5bb645` | pull_request | Huawei MIT source headers | completed:success |
