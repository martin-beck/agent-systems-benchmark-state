...
| #132 | `test/capability-coverage-sink@6e467bbde40c` | `main` | UNSTABLE | COMPLETED:FAILURE, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS | test(cli): preserve external coverage sink |
...
| 34541163970 | `6e467bbde40c` | pull_request | Huawei MIT source headers | completed:success |
| 34541163962 | `6e467bbde40c` | pull_request | Hosted portability and native qualification | completed:failure |
