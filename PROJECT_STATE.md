...
| #126 | `fix/main-merge-integrity@44ca04d2adda` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, QUEUED: | tools: harden signed merge publication |
...
| --- | --- | --- | --- | --- |
| 35058303808 | `44ca04d2adda` | pull_request | Agent Workflow Quality shadow | queued:- |
| 35058303683 | `44ca04d2adda` | pull_request | Fault assurance | pending:- |
| 35058303639 | `44ca04d2adda` | pull_request | Hosted portability and native qualification | queued:- |
| 35058303600 | `44ca04d2adda` | pull_request | Formal assurance | pending:- |
| 35058303599 | `44ca04d2adda` | pull_request | Repository quality | pending:- |
| 35058303581 | `44ca04d2adda` | pull_request | Rust verification | queued:- |
| 35058303565 | `44ca04d2adda` | pull_request | Emulated aarch64 portability | pending:- |
| 35058303524 | `44ca04d2adda` | pull_request | Huawei MIT source headers | queued:- |
