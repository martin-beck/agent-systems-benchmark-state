...
| #179 | `feature/ar-1229-auth-application-integration@efd98941ca8f` | `main` | UNSTABLE | COMPLETED:FAILURE, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS | feat: integrate provider authentication application surfaces |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35033311343 | `efd98941ca8f` | pull_request | Rust verification | in_progress:- |
...
| 35033311311 | `efd98941ca8f` | pull_request | Formal assurance | in_progress:- |
| 35033311306 | `efd98941ca8f` | pull_request | Fault assurance | in_progress:- |
| 35033311305 | `efd98941ca8f` | pull_request | Huawei MIT source headers | completed:success |
| 35033311302 | `efd98941ca8f` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35033311299 | `efd98941ca8f` | pull_request | Agent Workflow Quality shadow | completed:success |
