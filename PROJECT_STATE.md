...
| --- | --- | --- | --- | --- | --- |
| #13 | `feature/agent-opencode@dfb0d548bf75` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS | agents: add pinned OpenCode adapter |
