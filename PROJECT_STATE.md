...
| #152 | `feature/authenticated-control-endpoint-handoff@f34e4f57e141` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS | AR-1060: bind authenticated broker acquisition to one request budget |
...
| 34776885313 | `f34e4f57e141` | pull_request | Formal assurance | in_progress:- |
| 34776885290 | `f34e4f57e141` | pull_request | Fault assurance | in_progress:- |
| 34776885281 | `f34e4f57e141` | pull_request | Huawei MIT source headers | completed:success |
