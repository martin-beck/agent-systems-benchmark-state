...
| #185 | `fix/main-merge-integrity-postmerge@e55988819f07` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, QUEUED:, QUEUED:, IN_PROGRESS:, IN_PROGRESS: | fix(policy): accept signed local protected merges |
...
| 35059195759 | `e55988819f07` | pull_request | Fault assurance | queued:- |
| 35059195753 | `e55988819f07` | pull_request | Huawei MIT source headers | in_progress:- |
| 35059195747 | `e55988819f07` | pull_request | Agent Workflow Quality shadow | in_progress:- |
...
| 35059195737 | `e55988819f07` | pull_request | Formal assurance | queued:- |
