...
| #225 | `feature/ar-1151-followup@8cb9553519df` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(control): expose authenticated provider model catalog |
...
| 35341892349 | `8cb9553519df` | pull_request | Repository quality | completed:failure |
| 35341892342 | `8cb9553519df` | pull_request | Emulated aarch64 portability | completed:success |
| 35341892318 | `8cb9553519df` | pull_request | Formal assurance | completed:success |
| 35341892282 | `8cb9553519df` | pull_request | Agent Workflow Quality shadow | completed:success |
