...
| --- | --- | --- | --- | --- | --- |
| #24 | `feature/agent-codex@eb03bd9d9ed5` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(agents): add bounded Codex adapter |
