...
| #183 | `feature/ar-1231@fd8eaef0c36d` | `main` | CLEAN | COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(replay): add typed strict launch contract |
...
| 35048737472 | `fd8eaef0c36d` | pull_request | Emulated aarch64 portability | completed:success |
| 35048737470 | `fd8eaef0c36d` | pull_request | Hosted portability and native qualification | completed:success |
| 35048737468 | `fd8eaef0c36d` | pull_request | Rust verification | completed:success |
| 35048475299 | `b62255428989` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35048475266 | `b62255428989` | pull_request | Repository quality | completed:cancelled |
| 35048475259 | `b62255428989` | pull_request | Emulated aarch64 portability | completed:cancelled |
| 35048475246 | `b62255428989` | pull_request | Rust verification | completed:cancelled |
