...
| #122 | `integration/ar0877-ar0906@f385fb27296a` | `main` | UNSTABLE | QUEUED:, QUEUED:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, QUEUED:, IN_PROGRESS:, QUEUED:, IN_PROGRESS: | test(formal): integration evidence for AR-0877 and AR-0906 |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34375035674 | `f385fb27296a` | pull_request | Emulated aarch64 portability | in_progress:- |
| 34375035653 | `f385fb27296a` | pull_request | Native platform evidence | in_progress:- |
| 34375035601 | `f385fb27296a` | pull_request | Fault assurance | in_progress:- |
| 34375035574 | `f385fb27296a` | pull_request | Rust verification | in_progress:- |
| 34375035488 | `f385fb27296a` | pull_request | Formal assurance | queued:- |
| 34375035480 | `f385fb27296a` | pull_request | Repository quality | in_progress:- |
| 34375035444 | `f385fb27296a` | pull_request | Agent Workflow Quality shadow | in_progress:- |
| 34375035422 | `f385fb27296a` | pull_request | Huawei MIT source headers | in_progress:- |
