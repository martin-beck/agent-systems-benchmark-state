...
| #179 | `feature/ar-1229-auth-application-integration@0a5ddb1c9895` | `main` | UNSTABLE | QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED:, QUEUED: | feat: integrate provider authentication application surfaces |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35033950504 | `0a5ddb1c9895` | pull_request | Formal assurance | pending:- |
| 35033950453 | `0a5ddb1c9895` | pull_request | Agent Workflow Quality shadow | queued:- |
| 35033950447 | `0a5ddb1c9895` | pull_request | Huawei MIT source headers | in_progress:- |
| 35033950443 | `0a5ddb1c9895` | pull_request | Fault assurance | queued:- |
| 35033950442 | `0a5ddb1c9895` | pull_request | Emulated aarch64 portability | pending:- |
| 35033950435 | `0a5ddb1c9895` | pull_request | Hosted portability and native qualification | queued:- |
| 35033950410 | `0a5ddb1c9895` | pull_request | Rust verification | in_progress:- |
| 35033950391 | `0a5ddb1c9895` | pull_request | Repository quality | queued:- |
