...
| --- | --- | --- | --- | --- | --- |
| #13 | `feature/agent-opencode@5037401b1571` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | agents: add pinned OpenCode adapter |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 34057489081 | `5037401b1571` | pull_request | Rust verification | in_progress:- |
| 34057489078 | `5037401b1571` | pull_request | Formal assurance | in_progress:- |
| 34057489067 | `5037401b1571` | pull_request | Repository quality | in_progress:- |
...
| 34056672038 | `bda6bc41760a` | push | Repository quality | completed:success |
