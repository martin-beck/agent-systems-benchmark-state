...
| #264 | `feature/ar-1356-control-runtime-attestation-primitive@70f8a3980cb0` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat(runtime): bind live enrollment to control attestation |
...
| 35921309049 | `70f8a3980cb0` | pull_request | Formal assurance | in_progress:- |
| 35921309046 | `70f8a3980cb0` | pull_request | Repository quality | in_progress:- |
| 35921309038 | `70f8a3980cb0` | pull_request | Agent Workflow Quality shadow | in_progress:- |
| 35921308991 | `70f8a3980cb0` | pull_request | Fault assurance | in_progress:- |
| 35921308988 | `70f8a3980cb0` | pull_request | Huawei MIT source headers | in_progress:- |
| 35921308947 | `70f8a3980cb0` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35921308932 | `70f8a3980cb0` | pull_request | Hosted portability and native qualification | in_progress:- |
