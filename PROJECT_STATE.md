...
| #288 | `codex/ar-1396-literature-selection@e1e532ea1d4e` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, QUEUED:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat(workloads): expose literature selection catalog |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 35987586186 | `e1e532ea1d4e` | pull_request | Agent Workflow Quality shadow | in_progress:- |
...
| 35987585910 | `e1e532ea1d4e` | pull_request | Fault assurance | queued:- |
| 35987585898 | `e1e532ea1d4e` | pull_request | Rust verification | in_progress:- |
| 35987585892 | `e1e532ea1d4e` | pull_request | Huawei MIT source headers | in_progress:- |
