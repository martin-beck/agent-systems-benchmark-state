...
| #207 | `feature/ar-1262-runtime-owned-launch-authority@c009185748a4` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:FAILURE, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(runtime): issue strict-replay launch authority |
...
| 35156798185 | `c009185748a4` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35156798177 | `c009185748a4` | pull_request | Repository quality | completed:failure |
| 35156798173 | `c009185748a4` | pull_request | Formal assurance | completed:success |
| 35156798145 | `c009185748a4` | pull_request | Hosted portability and native qualification | completed:success |
| 35156798140 | `c009185748a4` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35155265446 | `69e8b064d312` | push | Hosted portability and native qualification | completed:success |
| 35155265435 | `69e8b064d312` | push | Fault assurance | completed:success |
| 35155265432 | `69e8b064d312` | push | Emulated aarch64 portability | completed:success |
| 35155265425 | `69e8b064d312` | push | Rust verification | completed:success |
