...
| #287 | `repair/ar-1398-signed-protected-main-recovery@f5680de433bb` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS: | fix(integration): restore signed protected-main ancestry |
...
| 35984949137 | `f5680de433bb` | pull_request | Hosted portability and native qualification | in_progress:- |
...
| 35984949070 | `f5680de433bb` | pull_request | Fault assurance | in_progress:- |
| 35984949065 | `f5680de433bb` | pull_request | Formal assurance | in_progress:- |
