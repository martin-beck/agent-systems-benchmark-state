...
| #124 | `feature/openjiuwen-live@230084ef1ea8` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | test(agents): qualify pinned OpenJiuwen live execution |
...
| --- | --- | --- | --- | --- |
| 35068339811 | `230084ef1ea8` | pull_request | Rust verification | in_progress:- |
| 35068339809 | `230084ef1ea8` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35068339784 | `230084ef1ea8` | pull_request | Formal assurance | in_progress:- |
