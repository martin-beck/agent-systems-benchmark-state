...
| #299 | `codex/ar-1413-long-horizon-performance@f3ce43441740` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS: | feat(workloads): classify long-horizon and performance metrics |

## Recent workflows

| Run | SHA | Event | Workflow | State |
| --- | --- | --- | --- | --- |
| 36016715558 | `f3ce43441740` | pull_request | Agent Workflow Quality shadow | in_progress:- |
| 36016715537 | `f3ce43441740` | pull_request | Rust verification | in_progress:- |
| 36016715480 | `f3ce43441740` | pull_request | Hosted portability and native qualification | in_progress:- |
| 36016715438 | `f3ce43441740` | pull_request | Formal assurance | in_progress:- |
| 36016715388 | `f3ce43441740` | pull_request | Fault assurance | in_progress:- |
| 36016715383 | `f3ce43441740` | pull_request | Repository quality | in_progress:- |
| 36016715337 | `f3ce43441740` | pull_request | Huawei MIT source headers | completed:success |
| 36016715315 | `f3ce43441740` | pull_request | Emulated aarch64 portability | in_progress:- |
