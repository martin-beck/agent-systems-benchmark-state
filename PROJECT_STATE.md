...
| #262 | `feature/ar-1351-live-runtime-provisioning@d0b0cbefffdd` | `main` | UNSTABLE | COMPLETED:FAILURE, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS | feat(runtime): add owned live provisioning seam |
...
| 35910007547 | `d0b0cbefffdd` | pull_request | Repository quality | completed:failure |
| 35910007546 | `d0b0cbefffdd` | pull_request | Hosted portability and native qualification | completed:success |
| 35910007544 | `d0b0cbefffdd` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35910007538 | `d0b0cbefffdd` | pull_request | Emulated aarch64 portability | completed:success |
...
| 35905431660 | `a6ef99b07d15` | pull_request | Formal assurance | completed:failure |
