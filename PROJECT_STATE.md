...
| #177 | `feature/ar-1228-auth-backends-probes@ac65697ff82e` | `main` | UNSTABLE | IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, COMPLETED:SUCCESS, IN_PROGRESS:, IN_PROGRESS:, IN_PROGRESS:, COMPLETED:SUCCESS | feat(auth): bind concrete credential resolvers |
...
| 35022356125 | `ac65697ff82e` | pull_request | Emulated aarch64 portability | in_progress:- |
| 35022356106 | `ac65697ff82e` | pull_request | Formal assurance | in_progress:- |
| 35022356070 | `ac65697ff82e` | pull_request | Repository quality | in_progress:- |
| 35022356067 | `ac65697ff82e` | pull_request | Fault assurance | in_progress:- |
| 35022356026 | `ac65697ff82e` | pull_request | Agent Workflow Quality shadow | completed:success |
| 35022355954 | `ac65697ff82e` | pull_request | Rust verification | in_progress:- |
| 35022212892 | `4ee7eacc378f` | pull_request | Huawei MIT source headers | completed:success |
| 35022212788 | `4ee7eacc378f` | pull_request | Emulated aarch64 portability | completed:cancelled |
| 35022212775 | `4ee7eacc378f` | pull_request | Hosted portability and native qualification | completed:success |
| 35022212763 | `4ee7eacc378f` | pull_request | Repository quality | completed:cancelled |
