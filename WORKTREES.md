...
| --- | --- | --- | ---: | --- |
| `agent-systems-benchmark` | `main` | `8eff6f95d8c5` | 0 | behind 0, ahead 0 |
...
| `agent-systems-benchmark-frontend-control-api` | `feature/frontend-control-api` | `cbb764c45c61` | 20 | behind 43, ahead 1 |
...
| `agent-systems-benchmark-native-platform-lab` | `feature/native-platform-lab` | `b1669203308d` | 0 | behind 21, ahead 0 |
| `agent-systems-benchmark-native-platforms` | `feature/native-platforms` | `bdaf9c108226` | 0 | behind 41, ahead 17 |
| `agent-systems-benchmark-opendesk-strict-replay-http-compatibility` | `feature/opendesk-strict-replay-http-compatibility` | `f26216bde125` | 0 | behind 1, ahead 0 |
| `agent-systems-benchmark-platform-manifests` | `feature/platform-manifests` | `a800ca3b9169` | 0 | behind 135, ahead 0 |
| `agent-systems-benchmark-portable-metrics` | `feature/portable-metrics` | `a0f67bea1ffe` | 0 | behind 109, ahead 0 |
...
| `agent-systems-benchmark-redacted-request-pointer-replay` | `feature/redacted-request-pointer-replay` | `8eff6f95d8c5` | 5 | behind 0, ahead 0 |
...
| `agent-systems-benchmark-replay-codex` | `feature/replay-codex` | `612a5a7e3d47` | 1 | behind 6, ahead 0 |
...
| `agent-systems-benchmark-runtime-bundle-manifest` | `feature/runtime-bundle-manifest` | `4b2805d870df` | 0 | behind 17, ahead 0 |
| `agent-systems-benchmark-sandbox-runtime` | `feature/sandbox-runtime` | `ac4a23599649` | 0 | behind 94, ahead 0 |
| `agent-systems-benchmark-sandbox-test-portability` | `fix/sandbox-test-portability` | `23035acde688` | 0 | behind 82, ahead 0 |
| `agent-systems-benchmark-statistical-analysis` | `feature/statistical-analysis` | `3bcfd85dedd3` | 0 | behind 119, ahead 0 |
| `agent-systems-benchmark-strict-replay` | `feature/strict-replay` | `410ecc95b80e` | 0 | behind 107, ahead 0 |
| `agent-systems-benchmark-terminal-interface` | `feature/terminal-interface` | `d2e7b66ff6af` | 0 | behind 52, ahead 0 |
