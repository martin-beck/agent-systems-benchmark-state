...
| `agent-systems-benchmark-agent-goose` | `feature/agent-goose` | `08feca551df7` | 0 | behind 0, ahead 2 |
...
| `agent-systems-benchmark-fault-assurance` | `feature/fault-assurance` | `68ecb4e97d84` | 3 | behind 0, ahead 1 |
| changed files | - | - | - | `.github/workflows/fault-assurance.yml`, `crates/asb-store/tests/fault_assurance.rs`, `fault-assurance/README.md` |
...
| `agent-systems-benchmark-terminal-interface` | `feature/terminal-interface` | `203074e8054f` | 0 | behind 0, ahead 2 |
