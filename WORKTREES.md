...
| `agent-systems-benchmark-agent-goose` | `feature/agent-goose` | `c151450f4ef4` | 3 | behind 0, ahead 1 |
| changed files | - | - | - | `crates/asb-agents/README.md`, `crates/asb-agents/src/goose.rs`, `crates/asb-agents/tests/real_goose.rs` |
...
| `agent-systems-benchmark-fault-assurance` | `feature/fault-assurance` | `68ecb4e97d84` | 0 | behind 0, ahead 1 |
...
| `agent-systems-benchmark-terminal-interface` | `feature/terminal-interface` | `7c2d19ca9d92` | 1 | behind 0, ahead 1 |
