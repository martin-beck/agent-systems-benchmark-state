...
| `agent-systems-benchmark-agent-opencode` | `feature/agent-opencode` | `fa53386a97ab` | 0 | behind 7, ahead 2 |
...
| `agent-systems-benchmark-formal-assurance` | `feature/formal-assurance` | `2a495a99a657` | 1 | behind 0, ahead 2 |
| changed files | - | - | - | `outside-50251` |
...
| `agent-systems-benchmark-sandbox-runtime` | `feature/sandbox-runtime` | `4d716973f483` | 1 | behind 0, ahead 0 |
