...
| `agent-systems-benchmark-native-platforms` | `feature/native-platforms` | `bdaf9c108226` | 0 | behind 44, ahead 17 |
| `agent-systems-benchmark-opendesk-strict-replay-http-compatibility` | `feature/opendesk-strict-replay-http-compatibility` | `f26216bde125` | 0 | behind 4, ahead 0 |
| `agent-systems-benchmark-platform-manifests` | `feature/platform-manifests` | `a800ca3b9169` | 0 | behind 138, ahead 0 |
| `agent-systems-benchmark-portable-metrics` | `feature/portable-metrics` | `a0f67bea1ffe` | 0 | behind 112, ahead 0 |
...
| `agent-systems-benchmark-redacted-request-pointer-replay` | `feature/redacted-request-pointer-replay` | `8eff6f95d8c5` | 5 | behind 3, ahead 0 |
| changed files | - | - | - | `crates/asb-replay/README.md`, `crates/asb-replay/src/redaction.rs`, `crates/asb-replay/src/service.rs`, `crates/asb-replay/tests/redaction.rs`, `crates/asb-replay/tests/strict_replay.rs` |
...
| `agent-systems-benchmark-replay-codex` | `feature/replay-codex` | `612a5a7e3d47` | 1 | behind 9, ahead 0 |
| changed files | - | - | - | `crates/asb-agents/tests/replay_codex.rs` |
| `agent-systems-benchmark-replay-evaluation` | `feature/replay-evaluation` | `3d04a2d5a3b3` | 0 | behind 140, ahead 0 |
| `agent-systems-benchmark-replay-opencode` | `feature/replay-opencode` | `eec93a240b58` | 0 | behind 10, ahead 0 |
| `agent-systems-benchmark-replay-opendesk` | `feature/replay-opendesk` | `24a5519ef006` | 0 | behind 1, ahead 0 |
| `agent-systems-benchmark-replay-pacing` | `feature/replay-pacing` | `73d28a431c78` | 0 | behind 95, ahead 0 |
| `agent-systems-benchmark-runner-isolation-hardening` | `fix/runner-isolation-hardening` | `9b4e7084e02c` | 0 | behind 30, ahead 0 |
| `agent-systems-benchmark-runner-privacy-guard-remediation` | `fix/runner-canary-privacy-guards` | `c25e3d20d0dd` | 0 | behind 32, ahead 0 |
| `agent-systems-benchmark-runtime-bundle-manifest` | `feature/runtime-bundle-manifest` | `4b2805d870df` | 0 | behind 20, ahead 0 |
| `agent-systems-benchmark-sandbox-runtime` | `feature/sandbox-runtime` | `ac4a23599649` | 0 | behind 97, ahead 0 |
| `agent-systems-benchmark-sandbox-test-portability` | `fix/sandbox-test-portability` | `23035acde688` | 0 | behind 85, ahead 0 |
| `agent-systems-benchmark-statistical-analysis` | `feature/statistical-analysis` | `3bcfd85dedd3` | 0 | behind 122, ahead 0 |
| `agent-systems-benchmark-strict-replay` | `feature/strict-replay` | `410ecc95b80e` | 0 | behind 110, ahead 0 |
| `agent-systems-benchmark-terminal-interface` | `feature/terminal-interface` | `d2e7b66ff6af` | 0 | behind 55, ahead 0 |
