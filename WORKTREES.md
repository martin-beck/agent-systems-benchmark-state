...
| `agent-systems-benchmark-agent-goose` | `feature/agent-goose` | `c151450f4ef4` | 0 | behind 0, ahead 1 |
...
| `agent-systems-benchmark-terminal-interface` | `feature/terminal-interface` | `3374572d0947` | 3 | behind 0, ahead 1 |
| changed files | - | - | - | `crates/asb-cli/src/lib.rs`, `crates/asb-cli/tests/cli_e2e.rs`, `crates/asb-runtime/src/scheduler.rs` |
