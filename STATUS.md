...
| --- | --- | --- | --- | --- |
| P1 | [AR-0305](tasks/AR-0305-agent-gemini.md): Implement Gemini CLI client adapter | contracts-20260906 | Run pinned Gemini CLI through noninteractive JSON events. | Await independent immutable review of repaired exact d381d34; publish only after approval, then require exact-head hosted CI. |
