...
| --- | --- | --- | --- | --- |
| P1 | [AR-0819](tasks/AR-0819-ssh-remote-bootstrap.md): Add SSH remote discovery and bootstrap | replay_20260909 | Use configured SSH hosts as the safe default path to a remote runner and help establish dedicated key authentication. | Publish signed commit 980276d and open a PR; then monitor exact-head required CI before integration. |
