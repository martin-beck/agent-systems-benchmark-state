...
| --- | --- | --- | --- | --- |
| P1 | [AR-0806](tasks/AR-0806-tui-history-analysis.md): Add terminal history and analysis | quality_20260906 | Browse recent runs, repeat their validated plans, and analyse comparable results from the TUI. | Review rebased 031a4516cbb3addc184ab3c4b0f4c683aa14755d against main 3514089fa378bd50629c9794b215fd53c8ea7d5d, confirming &#x27;=&#x27; range-diff from 3844c28, two-path scope, signature/DCO, duplicate atomicity, gates and AR-0875 limit. Then update PR #89 with force-with-lease and require exact-head CI. |
