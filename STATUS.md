...
| --- | --- | --- | --- | --- |
| P1 | [AR-0859](tasks/AR-0859-openjiuwen-live.md): Qualify pinned OpenJiuwen live execution | codex-longrun-openjiuwen-live-20260909 | Qualify pinned OpenJiuwen live execution. | Create the missing declared worktree from exact origin/main, then implement and test the pinned live qualification. |
