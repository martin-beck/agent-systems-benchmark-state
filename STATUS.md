...
| --- | --- | --- | --- | --- |
| P0 | [AR-0510](tasks/AR-0510-replay-gemini.md): Qualify Gemini replay | quality_20260906 | Qualify replay conformance for Gemini. | Complete final privacy/scope/diff audit, create focused signed+DCO candidate, verify exact commit, and request immutable review before publication. |
