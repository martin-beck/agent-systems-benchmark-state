...
| P1 | [AR-0909](tasks/AR-0909-mini-swe-cancellation-reap-test-isolation.md): Harden mini-SWE cancellation reap test isolation | quality_20260906 | Make mini-SWE cancellation/reaping tests deterministic without weakening production lifecycle guarantees. | Fresh immutable review of 236e007e, then guarded PR #127 update and exact-head CI; keep formal AR-0877 failure separate and do not merge. |
