...
| P1 | [AR-0909](tasks/AR-0909-mini-swe-cancellation-reap-test-isolation.md): Harden mini-SWE cancellation reap test isolation | quality_20260906 | Make mini-SWE cancellation/reaping tests deterministic without weakening production lifecycle guarantees. | Widen only bounded cancellation-test readiness and teardown budgets for loaded hosted emulation, rerun native/QEMU stress and full gates, then request immutable review. Do not merge PR #127. |
