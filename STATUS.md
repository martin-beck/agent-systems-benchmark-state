...
flowchart LR
    ...
    subgraph series_10["10 - Reliability and release"]
        ...
        AR_1013["AR-1013 - Open"]:::status_open
        ...
        AR_1040["AR-1040 - In progress"]:::status_in_progress
        AR_1041["AR-1041 - Planned"]:::status_planned
        AR_1042["AR-1042 - Planned"]:::status_planned
    end
    AR_0001 --> AR_0002
    AR_0001 --> AR_0003
    AR_0001 --> AR_0101
...
| --- | --- | --- | --- | --- |
| P0 | [AR-1010](tasks/AR-1010-ratatui-crossterm-foundation.md): Adopt Ratatui/Crossterm TUI foundation | codex-ar1010-final-review-20260911 | Adopt Ratatui and Crossterm as the supported professional TUI foundation. | Mark PR #9 ready, squash-merge exact reviewed tree 6521148 with valid lowercase GitHub-author DCO, then verify protected main tree, signature and post-merge CI before release. |
...
| P0 | [AR-1040](tasks/AR-1040-protected-merge-signature-policy.md): Reconcile protected-merge signature verification | codex-ar1040-final-integration-20260911 | Align offline signature policy with the repository-required GitHub merge path. | Monitor rerun of PR #135 Rust checks and remaining exact-head CI; freeze only after all 12 checks pass, then request different-agent review. Do not merge. |
...
| P0 | [AR-1038](tasks/AR-1038-capability-coverage-sink.md): Preserve coverage sinks in sanitized CLI child tests | Unclaimed | Prevent sanitized capability child tests from writing default profraw files into the source checkout. | Obtain a new immutable independent review of PR #132 exact head 69888a33cdf8383f4155d3dca1e9180104770b33/tree 42fd9229538ab7183b71a0517ca6c5bd751bdb99. All 12 exact-head checks are terminal SUCCESS. Do not merge without approval. |
...
| P0 | [AR-1041](tasks/AR-1041-gemini-hook-readiness-race.md): Make Gemini hook readiness publication atomic | Unclaimed | Eliminate the load-sensitive Gemini hook readiness race without weakening validation. | Reproduce the readiness-file truncate/write race with deterministic barriers, then implement atomic publication and fail-closed bounded observation. |
| P0 | [AR-1042](tasks/AR-1042-tmux-alternate-screen-readiness.md): Capture alternate-screen TUI readiness deterministically | Unclaimed | Make tmux TUI readiness capture deterministic on the actual alternate screen. | Replace primary-pane readiness polling with isolated alternate-screen capture and bounded diagnostics, then rerun trusted-main qualification. |
