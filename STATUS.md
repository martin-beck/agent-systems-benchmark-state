...
| --- | --- | --- | --- | --- |
| P0 | [AR-0105](tasks/AR-0105-sandbox-test-portability.md): Repair sandbox test target portability | contracts-20260906 | Remove repository-target assumptions from sandbox lease tests so clean external Cargo targets work. | Await coordinator integration of approved exact PR #18 head eea3d20; then run exact-main post-merge checks. |
