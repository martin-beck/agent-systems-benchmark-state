...
**203 ARs tracked** across 6 active status categories.
...
| --- | --- | --- | --- | --- |
| P0 | [AR-1010](tasks/AR-1010-ratatui-crossterm-foundation.md): Adopt Ratatui/Crossterm TUI foundation | codex-ar1010-asb-tui-renderer-20260910 | Adopt Ratatui and Crossterm as the supported professional TUI foundation. | Fresh immutable review of standalone asb-tui draft PR #9 exact head 1bab7ad34cdbf1647c7eea4953c3e60875c19ddc tree 5876314e4c6a9e54dccb3bcc027c6596f3a03912; require exact-head hosted CI green and do not merge without approval. |
...
| P0 | [AR-1038](tasks/AR-1038-capability-coverage-sink.md): Preserve coverage sinks in sanitized CLI child tests | codex-ar1038-coverage-20260911 | Prevent sanitized capability child tests from writing default profraw files into the source checkout. | Independently review immutable PR #132 exact head 51e18c62287816c7877925234ba37c0eb043f023 tree e35af4ee18030bead6b165aa561345f712a4ed34; wait for all 12 replacement exact-head checks terminal green; do not merge before approval. |
| P0 | [AR-1039](tasks/AR-1039-measurement-catalog-merge-attestation.md): Attest the measurement catalog merge boundary | codex-ar1039-catalog-merge-recovery-20260911 | Recover the measurement catalog publication boundary without rewriting protected main. | Push signed head 607a3afb, open an unmerged PR, verify exact-head CI, and request immutable independent review before any corrective merge. |
