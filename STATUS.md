...
| P1 | [AR-0904](tasks/AR-0904-contract-consistency.md): Machine-check protocol and artifact consistency | quality_20260906 | Make schemas, Rust types, protocol examples, CLI capability output and documentation mechanically agree. | Add a closed repository-wide contract catalog, deterministic generated catalog document, and fail-closed registry tests; then run the registered Rust schema/fixture/control conformance commands. |
