...
flowchart LR
    ...
    subgraph series_03["03 - Adapters and workloads"]
        ...
        AR_0310["AR-0310 - Planned"]:::status_planned
...
| --- | --- | --- | --- | --- |
| P0 | [AR-0105](tasks/AR-0105-sandbox-test-portability.md): Repair sandbox test target portability | contracts-20260906 | Remove repository-target assumptions from sandbox lease tests so clean external Cargo targets work. | Resolve newly exposed sandbox_boundary.rs target_root ownership, then rerun full isolated-target gates without masking. |
