...
| P2 | [AR-0202](tasks/AR-0202-kernel-diagnostics.md): Add optional kernel diagnostics | replay_20260906 | Integrate perf and optional eBPF diagnostics without making privileged tools mandatory. | Keep PR #61 immutable and green; obtain genuine privileged native aarch64 evidence through existing native-capacity work, then perform final review/merge/post-merge verification. Do not release AR-0202 before that evidence. |
