...
flowchart LR
    ...
    subgraph series_08["08 - Interfaces"]
        ...
        AR_0804["AR-0804 - Open"]:::status_open
...
| P1 | [AR-0804](tasks/AR-0804-tui-settings-wizard.md): Build the terminal settings wizard | Unclaimed | Guide users through agents, providers, workloads, resources, replay, metrics, and output settings. | Obtain serialized Cargo workspace/lock fence, then add standalone asb-tui crate with a pure capability-driven wizard state model and snapshot/negative tests before terminal rendering dependencies. |
