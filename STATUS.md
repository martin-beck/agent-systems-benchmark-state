...
| P2 | [AR-0402](tasks/AR-0402-external-code-workloads.md): Integrate SWE-bench and Aider Polyglot | root-coordination-20260906 | Add versioned external workload adapters without vendoring datasets. | Repair or replace unavailable Aider revision through a fresh provenance review, verify Exercism archives, then implement production adapter integration. |
