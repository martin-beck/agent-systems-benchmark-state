...
| --- | --- | --- | --- | --- |
| P1 | [AR-0315](tasks/AR-0315-provider-parity-conformance.md): Verify cross-agent provider parity | quality_20260906 | Conformance-test identical OpenAI and Ollama profiles across the complete supported-agent matrix. | Await coordinator serialized merge authorization for PR #84 exact head 7a5332dd3d0329343cf27b2433818b749bfdd355; after authorization use signed/DCO no-ff integration and require all exact-main postmerge workflows before release. |
