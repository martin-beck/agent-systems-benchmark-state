...
| --- | --- | --- | --- | --- |
| P0 | [AR-1010](tasks/AR-1010-ratatui-crossterm-foundation.md): Adopt Ratatui/Crossterm TUI foundation | codex-ar1010-trust-repair-20260911 | Adopt Ratatui and Crossterm as the supported professional TUI foundation. | Wait for PR #9 Repository quality at exact head 0301179, then release OPEN for a fresh independent immutable reviewer; no merge. |
