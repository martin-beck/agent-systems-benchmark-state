...
| P1 | [AR-0503](tasks/AR-0503-strict-replay.md): Implement strict provider response replay | replay-20260906 | Serve local recorded responses while real agent and tools execute. | Push exact signed candidate cdd76f9 without rewrite, open focused PR against exact main c9e3653, monitor immutable-head x86_64/aarch64 and quality CI, and await independent review. |
