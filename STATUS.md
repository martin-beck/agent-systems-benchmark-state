...
| --- | --- | --- | --- | --- |
| P0 | [AR-1010](tasks/AR-1010-ratatui-crossterm-foundation.md): Adopt Ratatui/Crossterm TUI foundation | codex-ar1010-trust-repair-20260911 | Adopt Ratatui and Crossterm as the supported professional TUI foundation. | Push signed successor 0301179/tree 15d4619 to PR #9, verify exact-head CI, then release OPEN for a fresh independent reviewer; no merge. |
