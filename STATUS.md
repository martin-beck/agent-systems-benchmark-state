...
**220 ARs tracked** across 6 active status categories.
...
flowchart LR
    ...
    subgraph series_10["10 - Reliability and release"]
        ...
        AR_1056["AR-1056 - Planned"]:::status_planned
    end
    AR_0001 --> AR_0002
    AR_0001 --> AR_0003
    AR_0001 --> AR_0101
...
| [AR-1056](tasks/AR-1056-tmux-socket-connect-diagnostics.md) | None | None |
...
| P0 | [AR-1056](tasks/AR-1056-tmux-socket-connect-diagnostics.md): Diagnose tmux socket connection stage | Unclaimed | Diagnose and repair the remaining trusted tmux socket connection-stage failure. | Add privacy-safe AF_UNIX connection substages at exact asb-tui main 092cf20a, obtain trusted-main evidence, then repair only the proven predicate. |
