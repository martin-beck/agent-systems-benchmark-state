...
| P2 | [AR-0402](tasks/AR-0402-external-code-workloads.md): Integrate SWE-bench and Aider Polyglot | root-coordination-20260906 | Add versioned external workload adapters without vendoring datasets. | Verify Exercism archives and implement production adapter integration; do not promote evaluator support without image/SBOM/oracle evidence. |
