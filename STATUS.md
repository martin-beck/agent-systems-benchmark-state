...
| P1 | [AR-0805](tasks/AR-0805-tui-run-control.md): Add terminal run control and status | quality_20260906 | Start validated runs and monitor current progress, health, metrics, failures, and cancellation from the TUI. | Rerun only contract consistency and the remaining coverage/failure/platform/workflow/dependency/privacy gates with exact baseline b2707c482876dcfb42c756c39165f6ecdb5c7c10, then amend/resign the unpublished candidate and request fresh immutable review. |
