...
| P0 | [AR-1040](tasks/AR-1040-protected-merge-signature-policy.md): Reconcile protected-merge signature verification | codex-ar1040-merge-signature-20260911 | Align offline signature policy with the repository-required GitHub merge path. | Create isolated exact-cad9fa97 worktree, pin official GitHub Web Flow key, and implement narrowly gated protected-main verification with adversarial tests. |
