...
| P0 | [AR-0507](tasks/AR-0507-replay-opendesk.md): Qualify OpenDesk replay | replay_20260906 | Qualify replay conformance for OpenDesk. | Implement and test the authorized deterministic SHA-256 route run root in OpenDesk-owned paths; shared replay header-token and SSE-without-stream repairs remain serialized blockers. |
