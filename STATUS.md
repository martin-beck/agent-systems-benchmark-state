...
| P1 | [AR-0869](tasks/AR-0869-cli-multi-agent-provider-selection.md): Add CLI multi-agent provider selection | replay_20260906 | Select several agents and apply one preconfigured provider profile through inspectable command-line options. | Merge PR #88 exact head 0d9d317716d557b916e4da7022f58197d287987a into base 559fbcc825234bb98a64ba554a53f38b004d24f6 using the signed no-ff coordinator path; then run exact-main post-merge gates before release. |
