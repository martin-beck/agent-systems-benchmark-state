...
| P0 | [AR-1040](tasks/AR-1040-protected-merge-signature-policy.md): Reconcile protected-merge signature verification | codex-ar1040-merge-signature-20260911 | Align offline signature policy with the repository-required GitHub merge path. | Monitor PR #135 exact-head CI at d6fa883; when all 12 checks are green, freeze the immutable head and request different-agent security review. Do not merge. |
