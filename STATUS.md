...
| P1 | [AR-0801](tasks/AR-0801-terminal-interface.md): Implement terminal and automation interfaces | root-coordination-20260906 | Provide doctor, plan, run, sweep, compare and report with stable JSON output. | Finish exact-tree validation of the repaired successor, create a new signed DCO immutable candidate, and request fresh independent review. |
