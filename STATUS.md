...
| P2 | [AR-0202](tasks/AR-0202-kernel-diagnostics.md): Add optional kernel diagnostics | replay_20260906 | Integrate perf and optional eBPF diagnostics without making privileged tools mandatory. | Add the required adjacent Huawei 2026 and SPDX MIT header to kernel.rs, run focused policy/header tests and Rust gates, then inspect/classify ARM Rust result before publishing a signed repair. |
