...
| --- | --- | --- | --- | --- |
| P1 | [AR-0204](tasks/AR-0204-capacity-sweeps.md): Implement capacity sweeps and arrival scheduling | contracts-20260906 | Run repeated closed-loop and open-loop experiments with bounded concurrency. | Hold exact clean rebased successor 0717d4a unpublished pending coordinator publication authorization. |
| P1 | [AR-0303](tasks/AR-0303-agent-aider.md): Implement aider client adapter | root-coordination-20260906 | Support unattended aider editing with bounded input, output and repository changes. | Document verified aider boundary and limitations, rebase once onto current main, then run full exact-tree quality and publication gates. |
