...
| --- | --- | --- | --- | --- |
| P0 | [AR-1010](tasks/AR-1010-ratatui-crossterm-foundation.md): Adopt Ratatui/Crossterm TUI foundation | codex-ar1010-asb-tui-renderer-20260910 | Adopt Ratatui and Crossterm as the supported professional TUI foundation. | Complete bounded tmux/screen evidence, full standalone asb-tui gates and coverage, then publish a signed+DCO immutable successor to draft PR 9 for independent review; AR-1025 exclusively owns live client negotiation, polling, and responsiveness. |
