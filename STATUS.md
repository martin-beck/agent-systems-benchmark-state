...
| --- | --- | --- | --- | --- |
| P1 | [AR-0804](tasks/AR-0804-tui-settings-wizard.md): Build the terminal settings wizard | quality_20260906 | Guide users through agents, providers, workloads, resources, replay, metrics, and output settings. | Add negotiated selector/search/navigation snapshot coverage and plain-terminal accessibility rendering without widening launch authority; then run full workspace and privacy/policy gates before signed candidate. |
