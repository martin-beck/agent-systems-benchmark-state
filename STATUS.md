...
| --- | --- | --- | --- | --- |
| P1 | [AR-0313](tasks/AR-0313-all-agents-provider.md): Configure one provider for all agents | quality_20260906 | Let test plans select one provider profile for every chosen supported agent atomically. | Rerun only interrupted failure-fixture bundle with pinned cargo PATH, then run pending Gitleaks and anchored added-line privacy scan; no product repair indicated by the FileNotFoundError. |
