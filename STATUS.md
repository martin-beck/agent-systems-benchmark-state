...
| P1 | [AR-0877](tasks/AR-0877-formal-tla-artifact-availability.md): Repair formal TLA artifact availability | quality_20260906 | Repair the formal workflow&#x27;s unavailable TLA+ artifact pin without weakening provenance or offline verification. | Monitor PR #120 exact-head CI at 55fdd686; do not merge until every required check is terminal green and coordinator reauthorizes integration. |
