...
| --- | --- | --- | --- | --- |
| P0 | [AR-1010](tasks/AR-1010-ratatui-crossterm-foundation.md): Adopt Ratatui/Crossterm TUI foundation | replay_20260906 | Adopt Ratatui and Crossterm as the supported professional TUI foundation. | Coordinator decision required: no released Ratatui closure satisfies deny.toml without allowing Zlib or carrying a patched dependency. |
