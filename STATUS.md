...
| P1 | [AR-0877](tasks/AR-0877-formal-tla-artifact-availability.md): Repair formal TLA artifact availability | quality_20260906 | Repair the formal workflow&#x27;s unavailable TLA+ artifact pin without weakening provenance or offline verification. | Finish remaining dependency/failure/coverage gates after path-scoped privacy scan, then stage and create signed candidate for independent review. |
