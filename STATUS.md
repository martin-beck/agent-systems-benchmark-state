...
| P2 | [AR-0202](tasks/AR-0202-kernel-diagnostics.md): Add optional kernel diagnostics | replay_20260906 | Integrate perf and optional eBPF diagnostics without making privileged tools mandatory. | Wait for exact-main post-merge checks, run local post-merge verification, then retain AR-0202 in progress pending genuine native aarch64 evidence; do not release as done yet. |
