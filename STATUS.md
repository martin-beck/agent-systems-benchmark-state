...
| --- | --- | --- | --- | --- |
| P1 | [AR-0307](tasks/AR-0307-agent-goose.md): Implement goose client adapter | quality-20260906 | Run pinned AAIF goose in no-session structured mode. | Create focused signed+DCO immutable Goose candidate from exact e85548d base; rerun commit-sensitive scope/privacy/signature gates and await independent review before publication. |
