...
| P1 | [AR-0201](tasks/AR-0201-portable-metrics.md): Collect portable system and session metrics | quality-20260906 | Collect procfs and cgroup v2 CPU, memory, I/O, faults, pressure and throttling. | Await repeat independent immutable-head review of repaired PR #12 exact a0f67bea1ffe50fd80bc42009761a4388798603a; all local and exact-head hosted checks are green. Retain Cargo workspace/lock fence. |
