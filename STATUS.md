...
| P1 | [AR-0401](tasks/AR-0401-engineering-workloads.md): Implement original engineering workloads | replay-20260906 | Deliver bug fix, feature addition, refactoring, test generation, dependency migration, build repair and repository navigation fixtures via extension API. | Repair scratch-root boundary, rerun exact full gates, and submit a signed successor to superseded 3bef7cf for independent review. |
