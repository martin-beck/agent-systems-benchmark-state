...
| P1 | [AR-0902](tasks/AR-0902-fault-assurance.md): Add fuzz mutation and lifecycle fault campaigns | contracts-20260906 | Stress parser, archive, path, recovery and cleanup boundaries with meaningful failure injection. | Repair PR #28 bounded-fuzz dependency-policy failure with an explicit independent fuzz-workspace license/policy; validate and publish a focused signed DCO successor, then require fresh exact-head CI. |
