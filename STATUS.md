...
| --- | --- | --- | --- | --- |
| P0 | [AR-0897](tasks/AR-0897-main-merge-integrity.md): Restore main merge integrity | contracts_20260906 | Repair the current main merge-boundary failure and enforce a signed DCO-bearing integration path. | Hold PR 126 at bd6f450; after AR-0877 and AR-0909 integrate, rebase once and require fresh all-green exact-head CI before merge. |
