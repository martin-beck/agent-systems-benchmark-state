...
flowchart LR
    ...
    subgraph series_08["08 - Interfaces"]
        ...
        AR_0834["AR-0834 - In progress"]:::status_in_progress
    end
...
| P1 | [AR-0834](tasks/AR-0834-handoffctl-lint-regression.md): Repair handoffctl lint regression | contracts-20260906 | Repair the coordination-tool Ruff regression discovered during AR-0830 reconciliation. | After coordinator shortens or clears AR-0830 done-task next_action, rebase e7cf1f2f once onto exact state main with re-signing, rerun schema/render/live doctor and complete quality gates, then request immutable review. |
