...
| --- | --- | --- | --- | --- |
| P1 | [AR-0857](tasks/AR-0857-openjiuwen-provenance.md): Pin OpenJiuwen source, package, and license provenance | replay_20260909 | Pin OpenJiuwen source, package, and license provenance. | Publish signed commit addcfab and open a PR; then monitor exact-head required CI before any integration. |
