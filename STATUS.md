...
| --- | --- | --- | --- | --- |
| P1 | [AR-0305](tasks/AR-0305-agent-gemini.md): Implement Gemini CLI client adapter | contracts-20260906 | Run pinned Gemini CLI through noninteractive JSON events. | Await coordinator publication authorization for independently approved exact d381d34; then push with exact lease and require exact-head hosted CI. |
