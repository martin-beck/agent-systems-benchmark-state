...
| P1 | [AR-0401](tasks/AR-0401-engineering-workloads.md): Implement original engineering workloads | replay-20260906 | Deliver bug fix, feature addition, refactoring, test generation, dependency migration, build repair and repository navigation fixtures via extension API. | Monitor exact immutable PR #20 head 41ffc6e quality, formal, x86_64 and aarch64 CI; investigate/repair any failure and await coordinator integration authorization. |
