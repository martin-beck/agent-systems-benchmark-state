...
| P0 | [AR-1030](tasks/AR-1030-ratatui-dependency-closure.md): Resolve the Ratatui dependency closure | codex-ar1030-ratatui-policy-20260910 | Make the maintained Ratatui release consumable by standalone asb-tui without hiding supply-chain exceptions. | Wait for exact-head PR #11 CI; after green, reconcile the nonblocking AR-1022 classification wording during rebase/merge ordering, then merge and unblock AR-1010. |
