...
flowchart LR
    ...
    subgraph series_10["10 - Reliability and release"]
        ...
        AR_1046["AR-1046 - Planned"]:::status_planned
    end
    AR_0001 --> AR_0002
    AR_0001 --> AR_0003
    AR_0001 --> AR_0101
...
| P0 | [AR-1046](tasks/AR-1046-serialize-emulated-aarch64-agent-tests.md): Serialize emulated AArch64 agent tests | Unclaimed | Make the emulated AArch64 asb-agents fake-node readiness fixtures deterministic without changing production semantics. | Obtain approval for the narrow two-file test/CI plan, then promote and claim before any product edit. |
