...
| P1 | [AR-0503](tasks/AR-0503-strict-replay.md): Implement strict provider response replay | replay-20260906 | Serve local recorded responses while real agent and tools execute. | Correct immutable privacy range scan, then update five-path candidate onto exact current main c9e3653 without taking or modifying the Cargo fence; rerun exact-tree gates before review. |
