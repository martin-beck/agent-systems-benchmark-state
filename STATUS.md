...
| P0 | [AR-1040](tasks/AR-1040-protected-merge-signature-policy.md): Reconcile protected-merge signature verification | codex-ar1040-merge-signature-20260911 | Align offline signature policy with the repository-required GitHub merge path. | Pin and narrowly verify GitHub Web Flow signatures only for canonical protected-main merge commits while keeping PR heads SSH-only. |
