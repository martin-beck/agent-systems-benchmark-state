...
| --- | --- | --- | --- | --- |
| P1 | [AR-0314](tasks/AR-0314-recording-source-choice.md): Choose matching replay or live provider execution | quality_20260906 | Offer matching prior recordings or an actual provider connection without silently choosing either. | Hold release. Product main e0554b5590cd53adf210837d88d1068d3781e2a4 contains PR #81, but exact-main repository-quality run 34241104757 failed because the GitHub-created merge commit lacks a matching Signed-off-by trailer. Await authorization for an additive signed+DCO policy-repair commit, then require fresh exact-main full CI and clean reconciliation. |
