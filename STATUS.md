...
| P0 | [AR-1043](tasks/AR-1043-protected-topic-sync-topology.md): Qualify exact topic-tip synchronization merges | codex-ar1043-protected-topic-sync-20260911 | Accept one exact signed topic-tip sync merge without weakening protected-main policy. | Await immutable review of exact clean candidate 40a84dda234f250927bb36a5b3c46bb342f60149; once READY, publish/update PR #137 and require all 12 exact-head checks including AArch64 before any merge authorization. |
| P0 | [AR-1048](tasks/AR-1048-tmux-window-option-portability.md): Make tmux window-option setup portable | codex-ar1048-tmux-window-portability-20260911 | Use an explicit tmux window-option command so trusted-main terminal qualification is portable. | Await immutable different-agent review of signed+DCO head 72f2f5575054f2efba00d3e31a481c34f67b91fb tree f0e9da5847058e2dd6b2b01d0508f0c2a00b996e before publication and exact-head CI; do not merge. |
