...
flowchart LR
    ...
    subgraph series_10["10 - Reliability and release"]
        ...
        AR_1040["AR-1040 - Planned"]:::status_planned
    end
    AR_0001 --> AR_0002
    AR_0001 --> AR_0003
    AR_0001 --> AR_0101
...
| P0 | [AR-1040](tasks/AR-1040-protected-merge-signature-policy.md): Reconcile protected-merge signature verification | Unclaimed | Align offline signature policy with the repository-required GitHub merge path. | Pin and narrowly verify GitHub Web Flow signatures only for canonical protected-main merge commits while keeping PR heads SSH-only. |
