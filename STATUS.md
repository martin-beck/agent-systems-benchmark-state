...
| --- | --- | --- | --- | --- |
| P0 | [AR-1010](tasks/AR-1010-ratatui-crossterm-foundation.md): Adopt Ratatui/Crossterm TUI foundation | codex-ar1010-dependency-doc-repair-20260911 | Adopt Ratatui and Crossterm as the supported professional TUI foundation. | Push signed+DCO documentation successor 06769dc to PR #9 and require terminal exact-head CI plus fresh immutable review; do not merge. |
