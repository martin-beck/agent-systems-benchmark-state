...
flowchart LR
    ...
    subgraph series_03["03 - Adapters and workloads"]
        ...
        AR_0314["AR-0314 - Blocked"]:::status_blocked
        ...
        AR_0320["AR-0320 - In progress"]:::status_in_progress
    end
...
| --- | --- | --- | --- | --- |
| P1 | [AR-0320](tasks/AR-0320-provider-credential-integration.md): Integrate provider credential boundary | quality_20260906 | Integrate the verified environment credential resolver into the product workspace. | Independent immutable review of signed merge 0f92642 and recorded exact-tree gates; if approved, publish focused integration PR and require exact-head CI before merge/release. |
...
| P1 | [AR-0314](tasks/AR-0314-recording-source-choice.md): Choose matching replay or live provider execution | Unclaimed | Offer matching prior recordings or an actual provider connection without silently choosing either. | Serialize AR-0318 product publication/integration (e9a0e523 + 5d62546) onto product main or explicitly authorize its inclusion in AR-0314; then rebase AR-0314 and run the synthetic environment-credential live preflight without FD/helper claims. |
