...
| --- | --- | --- | --- | --- |
| P0 | [AR-0897](tasks/AR-0897-main-merge-integrity.md): Restore main merge integrity | replay_20260906 | Repair the current main merge-boundary failure and enforce a signed DCO-bearing integration path. | Run full gates and independent review of fb782963; do not publish or apply repository settings yet. |
