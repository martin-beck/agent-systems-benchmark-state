...
| P2 | [AR-0601](tasks/AR-0601-csb-integration.md): Prototype optional CSB integration | replay_20260906 | Reuse CSB application execution and monitoring where contracts fit ASB. | Await immutable review of compatibility decision candidate 524db90; do not publish. |
