...
| P1 | [AR-0805](tasks/AR-0805-tui-run-control.md): Add terminal run control and status | quality_20260906 | Start validated runs and monitor current progress, health, metrics, failures, and cancellation from the TUI. | Independent immutable review candidate fd81035f0a50436b75bb02727209bd8abd52a505 against exact parent b2707c482876dcfb42c756c39165f6ecdb5c7c10. Do not publish before review approval. Preserve explicit protocol/resource/native evidence gaps and AR-0855 header lines on any rebase. |
