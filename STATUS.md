...
| P1 | [AR-0504](tasks/AR-0504-replay-pacing.md): Implement pacing and replay overhead assessment | replay-20260906 | Support immediate, fixed-latency, original-paced and seeded synthetic scenarios. | Monitor PR #16 exact-head formal, quality, and native x86_64/aarch64 Rust CI; await coordinator immutable review and do not merge. |
