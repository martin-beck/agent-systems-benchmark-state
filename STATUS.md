...
| --- | --- | --- | --- | --- |
| P0 | [AR-1010](tasks/AR-1010-ratatui-crossterm-foundation.md): Adopt Ratatui/Crossterm TUI foundation | codex-ar1010-dependency-doc-repair-20260911 | Adopt Ratatui and Crossterm as the supported professional TUI foundation. | Push signed+DCO lifecycle-test isolation successor 2068872 to PR #9, require terminal exact-head hosted CI and fresh immutable review; do not merge. |
