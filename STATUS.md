...
| --- | --- | --- | --- | --- |
| P1 | [AR-0314](tasks/AR-0314-recording-source-choice.md): Choose matching replay or live provider execution | quality_20260906 | Offer matching prior recordings or an actual provider connection without silently choosing either. | Monitor fresh exact-main runs for signed+DCO additive attestation 76497db8f22c43762f0b5bcbc7f2549c1d17281d: formal 34241332324, repository quality 34241332330, fault 34241332366, Rust 34241332421, emulated-aarch64 34241332329. After all terminal success, fast-forward clean local main, run postmerge verification/doctor, then release AR-0314. |
