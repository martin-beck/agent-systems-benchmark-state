...
**204 ARs tracked** across 6 active status categories.
...
| --- | --- | --- | --- | --- |
| P0 | [AR-1010](tasks/AR-1010-ratatui-crossterm-foundation.md): Adopt Ratatui/Crossterm TUI foundation | codex-ar1010-dependency-doc-repair-20260911 | Adopt Ratatui and Crossterm as the supported professional TUI foundation. | Rerun failed exact-head hosted quality after 10/10 local lifecycle-suite reproductions pass; require terminal green and independent immutable review; no merge. |
...
| P0 | [AR-1040](tasks/AR-1040-protected-merge-signature-policy.md): Reconcile protected-merge signature verification | codex-ar1040-merge-signature-20260911 | Align offline signature policy with the repository-required GitHub merge path. | Push signed head d6fa883, open a draft PR with official key provenance and exact trust-boundary evidence, then monitor exact-head CI and await independent review. |
