...
| P0 | [AR-1306](../tasks/AR-1306-authenticated-fault-matrix-qualification.md): Authenticated strict-replay fault-matrix qualification | codex-ar1306-auth-listener-20260917 | Qualify the real authenticated strict-replay service and fault matrix missing from PR #221. | PR #222 exact head af44d47 is signed/DCO with explicit reviewed bubblewrap allowlist and pushed clean. Await all refreshed exact-head CI; then inspect native 15/15 and repeated parity evidence for independent approval. Do not merge before all checks and review are green. |
