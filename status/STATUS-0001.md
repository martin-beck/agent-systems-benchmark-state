...
| P0 | [AR-1300](../tasks/AR-1300-runtime-cassette-dispatch-seam.md): Runtime-to-replay cassette dispatch seam | ar1300_dispatch | Connect runtime-issued cassette operations to the real strict-replay dispatch path. | Wait for the shared lock, run repository policy with its supported arguments, and continue exact-head review/CI monitoring. |
