...
| P1 | [AR-1340](../tasks/AR-1340-attested-live-relay-namespace-handoff.md): Attested live-relay namespace and child handoff | codex-asb-ar1340-20260923 | Bind the live provider relay to an attested child namespace and integrate it without weakening offline or replay denial. | Review the signed checkpoint, integrate LiveProviderNamespaceHandoff into the runtime-owned live launch path, add backend descendant namespace exercise, then run full gates and publish PR. |
