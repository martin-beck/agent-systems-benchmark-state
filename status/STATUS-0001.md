...
| P0 | [AR-1307](../tasks/AR-1307-portable-tlc-runner-repair.md): Portable TLC runner repair and qualification | codex-ar1307-runner-repair-20260918 | Repair and publish a canonical, bounded portable TLC runner for AR-1293. | Obtain independent complete-diff review for 1fd1432eb, monitor PR #24 exact-head CI; then run disposable digest-pinned no-network QEMU portable-smoke repeatedly and required tiers, retaining sanitized schema-valid receipts. |
