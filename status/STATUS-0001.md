...
| --- | --- | --- | --- | --- |
| P1 | [AR-1347](../tasks/AR-1347-neutral-live-supervisor-composition.md): Neutral live-supervisor composition contract | codex-asb-ar1329-live-cli-luna56 | Add the dependency-safe opaque supervisor contract needed for live-provider acquisition. | Define and implement a neutral opaque credential-injection/supervisor composition contract that avoids an asb-runtime to asb-agents dependency cycle; then complete runtime-owned live acquisition with bounded target, lease, namespace, token, relay, credential capability, and teardown tests. Keep AR-1329 fail-closed until merge and post-merge verification. |
