...
| --- | --- | --- | --- | --- |
| P0 | [AR-1160](../tasks/AR-1160.md): Wizard control API | root | Expose wizard operations. | Implement v1.8 recording campaign execution/status/coverage/offline-default operations after the merged v1.7 baseline; preserve credential-free control protocol and add TUI mutation actions. |
