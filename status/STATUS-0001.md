...
| --- | --- | --- | --- | --- |
| P0 | [AR-1312](../tasks/AR-1312-post-merge-coverage-floor.md): Post-merge workspace coverage floor repair | ar1312_coverage_worker | Repair the post-merge workspace coverage deficit without weakening the 90&#37; floor. | Review signed+DCO commit 6958f08, publish PR from clean exact worktree, wait exact-head CI; then verify post-merge workspace coverage remains &gt;=90&#37; and release AR-1312. |
