...
| --- | --- | --- | --- | --- |
| P0 | [AR-1151](../tasks/AR-1151.md): Strict offline replay | codex_ar1151_followup | Replay strictly without providers. | Advance PR #225 through exact-head review and CI, then implement idempotent configuration/provider/auth mutations and recording campaign/offline-default operations; qualify all seven workloads before handing exact contracts to asb-tui. |
