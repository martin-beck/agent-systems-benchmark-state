...
**453 ARs tracked** across 7 active status categories.
...
| **Done** | Accepted, integrated, and durably verified | 298 |
...
flowchart LR
    ...
    subgraph series_12["12 - Additional work"]
        ...
        AR_1216["AR-1216 - In progress"]:::status_in_progress
    ...
    subgraph series_14["14 - Additional work"]
        ...
        AR_1431["AR-1431 - Planned"]:::status_planned
    end
    AR_0001 --> AR_0002
    AR_0001 --> AR_0003
    AR_0001 --> AR_0101
