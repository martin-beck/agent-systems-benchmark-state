...
| --- | --- | --- | --- | --- |
| P0 | [AR-1160](../tasks/AR-1160.md): Wizard control API | root | Wizard control API | Integrate the authenticated capture seam into the provider launch/runtime path, persist tuple coverage, then add v1.8 execute/progress/cancel/reconcile/offline-default operations and TUI controls. |
