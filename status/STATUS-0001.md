...
| --- | --- | --- | --- | --- |
| P1 | [AR-0814](../tasks/AR-0814-remote-enrollment-authorization.md): Secure remote enrollment and authorization | asb_ar0814_enrollment_authz | Provide the ASB protocol and CLI for explicit remote trust and least-privilege roles. | Implement or explicitly split the still-owned certificate issuance/import and durable pairing identity-store ceremony, provide a qualified OS-protected SecretBackend, and add the missing hostile threat-matrix evidence/tests. Then rerun full gates and request publication review. |
