...
| P0 | [AR-1140](../tasks/AR-1140.md): CLI setup wizard | asb_ar1232_lifecycle_router | Guide CLI setup and reconfiguration. | Implement bounded non-TTY setup/config command contract and tests; inspect existing CLI command dispatch first. |
