...
| P1 | [AR-1339](../tasks/AR-1339-live-provider-egress-backend.md): Runtime-owned live-provider egress backend | codex-asb-ar1339-20260923 | Implement the runtime-owned authenticated backend for explicit live provider egress. | Integrate ProviderEgressAuthorization with a runtime-owned network-capable relay/backend and CLI live path; typed endpoint/generation/route/deadline handoff contract and denial tests now pass, but no outbound socket is permitted yet. |
