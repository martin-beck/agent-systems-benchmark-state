...
| --- | --- | --- | --- | --- |
| P1 | [AR-1329](../tasks/AR-1329-live-provider-run-execution.md): Live-provider run execution for real agents | codex-asb-ar1329-live-cli-luna56 | Execute real agents against the selected provider through asb run and sweep with credential-free resolution. | Protected main is a336d674 after merged AR-1344/1345. CLI still has no production runtime-owned acquisition service: dispatch passes no factory, and constructing live SandboxLaunchInput/backend/relay requires unavailable credential, namespace, egress, and gate authority. Continue only with a sanctioned service seam; preserve fail-closed NetworkPolicy::Deny. |
