...
**384 ARs tracked** across 7 active status categories.
...
flowchart LR
    ...
    subgraph series_13["13 - Additional work"]
        ...
        AR_1360["AR-1360 - In progress"]:::status_in_progress
    end
    AR_0001 --> AR_0002
    AR_0001 --> AR_0003
    AR_0001 --> AR_0101
...
| --- | --- | --- | --- | --- |
| P0 | [AR-1360](../tasks/AR-1360-runtime-cli-dispatch-consumer.md): Runtime CLI dispatch consumer | codex-asb-runtime-attested-enrollment-luna56 | Connect authenticated runtime enrollment receipts to asb run and sweep without exposing authority. | Promote after AR-1359 is done, then implement the production asb run/sweep consumer for authenticated runtime enrollment receipts with fail-closed tests. |
