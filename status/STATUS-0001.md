...
| --- | --- | --- | --- | --- |
| P0 | [AR-1151](../tasks/AR-1151.md): Strict offline replay | codex_ar1151_followup | Replay strictly without providers. | Publish exact local head 3313860 after GitHub email verification, rerun hosted aarch64, then implement durable recording campaign lifecycle, cassette coverage reconciliation, offline-default application, and TUI adapter. |
