...
| --- | --- | --- | --- | --- |
| P1 | [AR-0813](../tasks/AR-0813-remote-control-transport.md): Add secure remote control transport | asb_ar0813_remote_transport | Carry the versioned frontend control API securely over IP without coupling runner lifetime to a client. | Post-merge 14b604f is GitHub-authored without Signed-off-by; coordinate signed protected-main recovery, then rerun exact-main policy and all post-merge gates before closing AR-0813. |
