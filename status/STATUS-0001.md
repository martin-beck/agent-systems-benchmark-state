...
**293 ARs tracked** across 6 active status categories.
...
flowchart LR
    ...
    subgraph series_12["12 - Additional work"]
        ...
        AR_1265["AR-1265 - Planned"]:::status_planned
    end
    AR_0001 --> AR_0002
    AR_0001 --> AR_0003
    AR_0001 --> AR_0101
...
| P0 | [AR-1265](../tasks/AR-1265-runtime-owned-replay-entrypoint.md): Runtime-owned strict-replay CLI entrypoint | Unclaimed | Provide a real runtime-owned strict-replay CLI entrypoint. | Promote after dependency verification; implement the runtime-owned authenticated replay entrypoint and real supervised lifecycle evidence described in the plan. |
