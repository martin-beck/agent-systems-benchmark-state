...
| P1 | [AR-1339](../tasks/AR-1339-live-provider-egress-backend.md): Runtime-owned live-provider egress backend | codex-asb-ar1339-20260923 | Implement the runtime-owned authenticated backend for explicit live provider egress. | Implement actual runtime-owned authenticated outbound relay: consume ProviderEgressAuthorization and ProviderEgressAllowlist, connect only prevalidated SocketAddr targets over HTTPS, reject redirects/DNS changes, and preserve NetworkPolicy::Deny offline/replay. |
