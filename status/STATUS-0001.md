...
**241 ARs tracked** across 6 active status categories.
...
flowchart LR
    ...
    subgraph series_11["11 - Additional work"]
        ...
        AR_1190["AR-1190 - Planned"]:::status_planned
...
| P0 | [AR-1190](../tasks/AR-1190.md): Authenticated agent catalog control | Unclaimed | Expose a verified, capability-aware local-agent catalog to asb-tui. | Define and implement the authenticated agent catalog control contract. |
