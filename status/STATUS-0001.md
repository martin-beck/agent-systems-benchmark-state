...
| P1 | [AR-0859](../tasks/AR-0859-openjiuwen-live.md): Qualify pinned OpenJiuwen live execution | Unclaimed | Qualify pinned OpenJiuwen live execution. | Provide an approved immutable Python 3.11 runtime/container image digest, or a reviewed interpreter artifact matching the live qualification identity contract; wheel closure is now complete but live test rejects the managed interpreter identity. |
