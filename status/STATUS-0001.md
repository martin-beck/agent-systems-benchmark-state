...
**303 ARs tracked** across 6 active status categories.
...
flowchart LR
    ...
    subgraph series_12["12 - Additional work"]
        ...
        AR_1275["AR-1275 - Planned"]:::status_planned
    end
    AR_0001 --> AR_0002
    AR_0001 --> AR_0003
    AR_0001 --> AR_0101
