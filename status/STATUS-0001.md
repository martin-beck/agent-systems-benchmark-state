...
| --- | --- | --- | --- | --- |
| P0 | [AR-1191](../tasks/AR-1191.md): Verified local-agent lifecycle | root-ar1191-review | Install, activate, verify and recover supported local benchmark agents safely. | Wait for exact-head hosted checks on lifecycle correlation/schema fixes at PR #169 head 3fa66e5c1ded9a797d45a5b9fb3606b39c2e11ce; then independently qualify against asb-tui PR #86. |
