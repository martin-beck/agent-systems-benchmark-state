...
| --- | --- | --- | --- | --- |
| P0 | [AR-1232](../tasks/AR-1232-sandboxed-replay-process-supervision.md): Sandboxed replay process supervision | asb_ar1232_sandbox_supervision | Supervise strict replay adapters inside the approved network-denied sandbox. | Native descendant-egress harness now passes 6/6 with explicit ASB_TEST_ROOT at abc0317; run full locked workspace and policy/privacy gates, then obtain independent exact-head review. Native capability must remain explicit in CI. |
