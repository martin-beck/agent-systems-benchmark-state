...
**308 ARs tracked** across 6 active status categories.
...
flowchart LR
    ...
    subgraph series_12["12 - Additional work"]
        ...
        AR_1280["AR-1280 - Planned"]:::status_planned
    end
    AR_0001 --> AR_0002
    AR_0001 --> AR_0003
    AR_0001 --> AR_0101
...
| P0 | [AR-1280](../tasks/AR-1280-cross-crate-replay-entrypoint.md): Cross-crate replay process entrypoint | Unclaimed | Implement the cross-crate runtime process entrypoint for primary strict replay. | Promote after dependency verification; implement the cross-crate authenticated replay process entrypoint from protected main. |
