...
| P0 | [AR-1300](../tasks/AR-1300-runtime-cassette-dispatch-seam.md): Runtime-to-replay cassette dispatch seam | ar1300_dispatch | Connect runtime-issued cassette operations to the real strict-replay dispatch path. | Run exact-head independent review and hosted PR #217 checks; fix any failures, then merge only after all required checks are green. |
