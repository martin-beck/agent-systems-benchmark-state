...
| --- | --- | --- | --- | --- |
| P0 | [AR-1210](../tasks/AR-1210-tutorial-contract-validator.md): Tutorial contract and syntax validator | asb_ar1210_tutorial_contract | Define offline tutorial steps and validate them against the ASB CLI grammar. | PR #184 exact head 984b2f8 after source-header repair; monitor all required checks and independently review resulting exact diff before any merge. |
