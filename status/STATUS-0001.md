...
| P0 | [AR-1307](../tasks/AR-1307-portable-tlc-runner-repair.md): Portable TLC runner repair and qualification | codex-ar1307-runner-repair-20260918 | Repair and publish a canonical, bounded portable TLC runner for AR-1293. | Rebuild data image only after verifying staged /jvm and pinned JAR are present; use fresh stage4 raw, unique seed, and fresh overlay. Confirm debugfs root lists state/jvm/tla2tools.jar before launching portable-smoke. |
