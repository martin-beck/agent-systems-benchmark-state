...
| P1 | [AR-1352](../tasks/AR-1352-runtime-live-bootstrap.md): Runtime-owned live bootstrap | codex-asb-runtime-acquisition-successor-luna56 | Add the private runtime-owned bootstrap source for live acquisition. | Commit the independently reviewed clean bootstrap slice with SSH signature and DCO, then publish through the reviewed PR workflow. Keep AR-1349/1329 fail-closed. |
