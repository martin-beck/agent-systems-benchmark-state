...
| --- | --- | --- | --- | --- |
| P0 | [AR-1151](../tasks/AR-1151.md): Strict offline replay | codex_ar1151_followup | Replay strictly without providers. | Publish exact local head d116ded after GitHub email verification, rerun hosted aarch64, then implement durable recording campaign execution/cassette reconciliation, offline-default application, and TUI adapter. |
