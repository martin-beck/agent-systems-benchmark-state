...
| --- | --- | --- | --- | --- |
| P0 | [AR-1151](../tasks/AR-1151.md): Strict offline replay | codex_ar1151_followup | Replay strictly without providers. | Obtain hosted runner service recovery or approved alternative evidence, then publish exact local head d116ded after GitHub email verification; continue recording campaign execution, cassette reconciliation, offline-default application, and TUI adapter. |
