...
**437 ARs tracked** across 7 active status categories.
...
| **Done** | Accepted, integrated, and durably verified | 276 |
...
flowchart LR
    ...
    subgraph series_14["14 - Additional work"]
        ...
        AR_1403["AR-1403 - In progress"]:::status_in_progress
        AR_1404["AR-1404 - In progress"]:::status_in_progress
        ...
        AR_1411["AR-1411 - Planned"]:::status_planned
        AR_1412["AR-1412 - Planned"]:::status_planned
        AR_1413["AR-1413 - Planned"]:::status_planned
    end
    AR_0001 --> AR_0002
    AR_0001 --> AR_0003
    AR_0001 --> AR_0101
