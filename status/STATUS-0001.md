...
| --- | --- | --- | --- | --- |
| P1 | [AR-0813](../tasks/AR-0813-remote-control-transport.md): Add secure remote control transport | asb_ar0813_remote_transport | Carry the versioned frontend control API securely over IP without coupling runner lifetime to a client. | Monitor PR202 exact head 22abb6e fresh dependency/fuzz and remaining checks to terminal; merge only after all required checks and independent approval. |
