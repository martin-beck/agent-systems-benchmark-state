...
**440 ARs tracked** across 7 active status categories.
...
| **Done** | Accepted, integrated, and durably verified | 285 |
...
flowchart LR
    ...
    subgraph series_14["14 - Additional work"]
        ...
        AR_1415["AR-1415 - Planned"]:::status_planned
        AR_1416["AR-1416 - Planned"]:::status_planned
    end
    AR_0001 --> AR_0002
    AR_0001 --> AR_0003
    AR_0001 --> AR_0101
