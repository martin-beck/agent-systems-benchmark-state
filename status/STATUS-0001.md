...
| P0 | [AR-1140](../tasks/AR-1140.md): CLI setup wizard | asb_ar1232_lifecycle_router | Guide CLI setup and reconfiguration. | Run final privacy/signature checks and independent exact-head review; prepare publication. Current head c7eddaf. |
