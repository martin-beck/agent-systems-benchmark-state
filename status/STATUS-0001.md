...
| P1 | [AR-1352](../tasks/AR-1352-runtime-live-bootstrap.md): Runtime-owned live bootstrap | codex-asb-runtime-acquisition-successor-luna56 | Add the private runtime-owned bootstrap source for live acquisition. | Repair or rerun the workspace gate after the recorded asb-cli state-root ownership collision; then independently review the clean bootstrap diff, commit signed+DCO, and publish. |
