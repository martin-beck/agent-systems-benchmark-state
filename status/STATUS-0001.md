...
| --- | --- | --- | --- | --- |
| P0 | [AR-1230](../tasks/AR-1230-authenticated-provider-request-seam.md): Authenticated provider-request seam and secret injection contract | asb_ar1230_auth_request_seam | Define the approved bounded provider authentication request and secret-injection seam. | PR #178 exact head fc71739 requires independent re-review and CI rerun. Added seam-local cancellation-before/after-sink, partial failure, and generation-race tests; focused tests now 6 passed. Delegated transport/application gates remain AR-1228/AR-1229. |
