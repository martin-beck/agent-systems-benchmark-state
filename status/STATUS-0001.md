...
| P1 | [AR-1352](../tasks/AR-1352-runtime-live-bootstrap.md): Runtime-owned live bootstrap | codex-asb-runtime-acquisition-successor-luna56 | Add the private runtime-owned bootstrap source for live acquisition. | Verify all seven post-merge workflows at merge commit 03b830bbec183477758877f8a2a9e00714d351c0; release AR-1352 only after every workflow is terminal success, then advance AR-1349. |
