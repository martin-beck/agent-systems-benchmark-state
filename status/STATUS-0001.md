...
| P0 | [AR-1240](../tasks/AR-1240-native-signed-bundle-fixture.md): Native signed-bundle supervisor fixture | asb_ar1240_native_fixture_worker | Add native signed-bundle fixture and end-to-end supervisor isolation tests. | Materialize and verify a signed supervisor/sidecar bundle fixture, then run the native Bubblewrap isolation matrix. |
