...
| P1 | [AR-1352](../tasks/AR-1352-runtime-live-bootstrap.md): Runtime-owned live bootstrap | codex-asb-runtime-acquisition-successor-luna56 | Add the private runtime-owned bootstrap source for live acquisition. | PR #263 remains exact-head e385a87; continue monitoring the four active required checks and obtain independent approval evidence. Merge only once all required checks are green, then verify post-merge. |
