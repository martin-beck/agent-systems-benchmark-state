...
flowchart LR
    ...
    subgraph series_12["12 - Additional work"]
        ...
        AR_1234["AR-1234 - Planned"]:::status_planned
    end
    AR_0001 --> AR_0002
    AR_0001 --> AR_0003
    AR_0001 --> AR_0101
...
| P0 | [AR-1234](../tasks/AR-1234-runtime-loopback-namespace.md): Runtime-owned loopback namespace capability | Unclaimed | Provide an approved runtime-owned loopback-only sandbox namespace capability. | Promote after review; implement runtime-owned loopback namespace capability with fail-closed fallback. |
