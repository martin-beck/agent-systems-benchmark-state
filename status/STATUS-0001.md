...
| --- | --- | --- | --- | --- |
| P0 | [AR-1160](../tasks/AR-1160.md): Wizard control API | root | Wizard control API | Run PR #227 exact-head gates after serialized coverage harness at 3e77bd3; merge when green, then wire runtime capture adapter and asb-tui recording controls. |
