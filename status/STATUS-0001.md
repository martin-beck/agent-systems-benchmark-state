...
**310 ARs tracked** across 6 active status categories.
...
flowchart LR
    ...
    subgraph series_12["12 - Additional work"]
        ...
        AR_1282["AR-1282 - Planned"]:::status_planned
    end
    AR_0001 --> AR_0002
    AR_0001 --> AR_0003
    AR_0001 --> AR_0101
...
| P0 | [AR-1282](../tasks/AR-1282-authenticated-replay-transport.md): Authenticated replay transport foundation | Unclaimed | Land the authenticated runtime-to-CLI replay transport foundation. | Promote after dependency verification; implement and merge the bounded authenticated replay transport foundation only. |
