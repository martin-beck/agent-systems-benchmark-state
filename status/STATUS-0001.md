...
| --- | --- | --- | --- | --- |
| P0 | [AR-0899](../tasks/AR-0899-gitleaks-revision-config-integrity.md): Align and harden Gitleaks execution | asb_ar0899_gitleaks | Resolve GitHub issue 118 by making local and CI Gitleaks scans deterministic and config changes fail closed. | Review clean exact head 62d9f12; rerun applicable gates after disposable target cleanup, then publish PR only after independent review. |
