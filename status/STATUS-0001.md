...
**457 ARs tracked** across 6 active status categories.
...
| **Done** | Accepted, integrated, and durably verified | 302 |
...
flowchart LR
    ...
    subgraph series_14["14 - Additional work"]
        ...
        AR_1435["AR-1435 - In progress"]:::status_in_progress
    end
    AR_0001 --> AR_0002
    AR_0001 --> AR_0003
    AR_0001 --> AR_0101
