...
| --- | --- | --- | --- | --- |
| P0 | [AR-1160](../tasks/AR-1160.md): Wizard control API | root | Wizard control API | Run PR #227 exact-head gates after lifecycle rejection coverage at ce71ffb; merge only after coverage and all required checks pass, then wire runtime capture adapter and asb-tui recording controls. |
