...
| --- | --- | --- | --- | --- |
| P0 | [AR-1357](../tasks/AR-1357-runtime-attested-enrollment-record.md): Runtime-attested enrollment record transport | codex-asb-runtime-attested-enrollment-luna56 | Transport authenticated enrollment records into runtime without exposing authority to the CLI. | Promote after AR-1356 is done, then implement the versioned control-issued enrollment record transport and opaque runtime ingestion with positive and negative tests. |
