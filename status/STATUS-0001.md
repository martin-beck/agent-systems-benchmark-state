...
| P0 | [AR-1307](../tasks/AR-1307-portable-tlc-runner-repair.md): Portable TLC runner repair and qualification | codex-ar1307-runner-repair-20260918 | Repair and publish a canonical, bounded portable TLC runner for AR-1293. | Supervision repair adfb775a0 is signed/DCO and focused tests pass (31). Push/update PR #24 and obtain independent review/CI. Only after review, rebuild pristine full fixture and rerun bounded full tier; do not merge before terminal evidence. |
