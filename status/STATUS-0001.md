...
flowchart LR
    ...
    subgraph series_13["13 - Additional work"]
        ...
        AR_1357["AR-1357 - Open"]:::status_open
    end
    AR_0001 --> AR_0002
    AR_0001 --> AR_0003
    AR_0001 --> AR_0101
...
| P0 | [AR-1357](../tasks/AR-1357-runtime-attested-enrollment-record.md): Runtime-attested enrollment record transport | Unclaimed | Transport authenticated enrollment records into runtime without exposing authority to the CLI. | Promote after AR-1356 is done, then implement the versioned control-issued enrollment record transport and opaque runtime ingestion with positive and negative tests. |
