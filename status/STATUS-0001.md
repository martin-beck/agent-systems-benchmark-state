...
| P0 | [AR-1232](../tasks/AR-1232-sandboxed-replay-process-supervision.md): Sandboxed replay process supervision | asb_ar1232_sandbox_supervision | Supervise strict replay adapters inside the approved network-denied sandbox. | d7ca82f adds executor recover_after_restart closure test and passes focused lifecycle test; remote is already at d7ca82f. Push exit 1 was stale expected-ref race, not product failure. Continue native stale/duplicate generation integration and rerun full gates. |
