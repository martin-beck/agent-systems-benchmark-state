...
| P0 | [AR-1238](../tasks/AR-1238-runtime-loopback-supervisor.md): Runtime-owned loopback supervisor | Unclaimed | Provide the runtime-owned private-namespace supervisor for loopback replay. | Package and pin asb_loopback_supervisor and sidecar in the trusted runtime bundle; then run real end-to-end cassette relay with authenticated host listener, egress denial, teardown, and unrelated-process tests. |
