...
Qualify the one-line experience and complete install lifecycle across the supported native matrix.

Implementation has not started. Read the linked plan before claiming.

- 2026-09-10T19:00:00+00:00: Added AR-1012 and AR-1026 dependencies so the advertised installation
  audit exercises the qualified standalone UI and exact cross-repository lifecycle, not historical
  bundled-TUI behavior.
